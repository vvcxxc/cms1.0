            ...
            <div class="popContent">
                ...
                <div class="content1">
                    ...
                    <div class="content1-line">
                        <div class="content">
                            <div class="contentLable required">库区编码</div>
                            <el-input type="text" v-model="formData.Code" style="width: 210px" :disabled="disabled" />
                        </div>
                        <div class="content">
                            <div class="contentLable required">库区名称</div>
                ...
                <div class="content1">
                    ...
                    <div class="content1-line">
                        <div class="content">
                            ...
                            <div style="position: relative">
                                <img :src="choose" alt="" @click="handleChoose('IOVariableKey1')" />
                            </div>
                        </div>
                        <div class="content">
                            <div class="contentLable required">入库巷道</div>
                            <el-input type="text" v-model="formData.IOVariableKey2" style="width: 240px"
                                :disabled="true" />
                            <div style="position: relative">
                                <img :src="choose" alt="" @click="
                                    handleChoose('IOVariableKey2')
                                " />
                            </div>
                        </div>
                    </div>
                    <div class="content1-line">
                        <div class="content">
                            ...
                            <el-input type="text" v-model="formData.IOVariableKey3" style="width: 240px"
                                :disabled="true" />
                            <div style="position: relative">
                                <img :src="choose" alt="" @click="
                                    handleChoose('IOVariableKey3')
                                " />
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        handleClick(str) {
            this.$emit('kqEditPopCallBack', str, this.formData);
        },

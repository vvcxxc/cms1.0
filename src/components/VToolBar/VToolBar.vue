        ...
        <div @click="warnIfon1" class="v-toolbar__content">
            <div class="header-top">
                ...
                <div class="header-screen" @click.stop="screenchange">
                    <img src="../../assets/images/tv_black_blue.png" alt v-if="$store.state.color == 'blackBlue'" />
                    <img src="../../assets/images/tv.png" alt v-else />
                </div>
                ...
                <img src="../../assets/images/yifu_black_blue.png" ref="warn_infoImg" alt
                    v-if="$store.state.color == 'blackBlue'" />
                <img src="../../assets/images/yifu.png" ref="warn_infoImg" v-else />
            </div>
            <div class="warn_pop1" v-show="yifu" @click.stop="yifu2"
                :class="{ colortip: $store.state.color == 'grey' }">
                <!-- <div class="left">
            <div class="radio">
              <div>
                <div class="white" :class="{selectradio:selectradio === 'white'}" @click="white"></div>
              </div>
          ...
          <div class="right">
                            <div class="radio">
                              <div>
                                <div class="lai" :class="{selectradio:selectradio === 'grey'}" @click="lai"></div>
                              </div>
                    ...
                    <div class="right">
                        <div class="radio">
                            <div>
                                <div class="blackBlue" :class="{
                                    selectradio:
                                        selectradio === 'blackBlue',
                                }" @click="blackBlue"></div>
                            </div>
                            <span>{{ lang.TechnologyBlue }}</span>
                        </div>
                    </div>
                </div>
                <div @click.stop="warnIfon()" class="warn-info">
                    <img src="../../assets/images/warn.png" class="warn_infoImg" ref="warn_infoImg" />
                    <span ref="warn_text" class="warn_text">{{
                        TotalNum
                    }}</span>
                </div>
            ...
            <div class="header-nav">
                <div v-if="header_login" @click.stop="headerFun()" class="header_login">
                    ...
                </div>
                <div class="nav-item" v-for="(item, index) in Menus" :key="index">
                    <router-link class="link-to" @click.native="sad1(item)" :to="{ path: item.to, query: { id: item.id } }"
                    ...
                    <div v-if="item.children && item.children.length > 0" class="nav-newItem"
                        ...
                        <div v-for="(newItem, newIndex) in item.children" :key="newIndex" class="newItem"
                            :class="{ colortip: $store.state.color == 'grey' }">
                            <router-link class="link-to" @click="fff(newItem.id)" :to="{
                                path: newItem.to,
                                query: { id: newItem.id },
                            }" v-if="item.children" :class="{
    nowchildren:
        nowchildrem === newItem.title
            ? true
            : false,
            ...
            <div v-if="headerNav2Show" class="header-nav header-nav2">
                <div class="nav-item nav-item1" v-for="(item, index) in Menus2" :key="index">
                    <router-link class="link-to" :to="{ path: item.to, query: { id: item.id } }"
    ...
    nowchildren:
        ...
        <div v-show="wranShow" class="warn_pop" :class="{ colordiv: $store.state.color == 'grey' }">
            ...
            <div @click="warnFun('点巡检管理')" class="warn_row1">
                <span class="text">{{
                    lang.PointInspectionManage_ToDoInspection
                }}</span>
                <span class="num">{{ pointInspectionNum }}</span>
            </div>
            <div @click="warnFun('保养管理')" class="warn_row1">
                <span class="text">{{
                    lang.MaintenanceManage_ToDoMaintenance
                }}</span>
        ...
        <div v-show="loginShow" class="login_pop" :class="{ colordiv: $store.state.color == 'grey' }">
            ...
            <div @click="modifyFun" class="login_row2">
                ...
                <span class="mofi">{{
                    localData.Main_Record_ChangePassword
                }}</span>
            </div>
        ...
        <div v-show="loginShow1" class="login_outPop">
            ...
            <div class="login_conter">
                <div>
                    {{
                        `${lang.Main_MessageBox_IfLoginOut} &lt;${userName1 == lang.SuperAdmin
                            ? 'SuperAdmin'
                            : userName1
                        }&gt; ?`
                    }}
            ...
            <div class="login_btn">
                <div @click="login_no" class="login_no">
                    {{ lang.MessageBox_NO }}
                </div>
                <div @click="login_yes" class="login_yes">
                    {{ lang.MessageBox_YES }}
                </div>
            </div>
        </div>
        ...
        <div v-show="loginShow2" class="login_outPop">
            ...
            <div class="login_btn">
                <div @click="login_confirm" class="login_confirm">
        ...
        <div v-show="warnPopShow" class="login_outPop">
            ...
            <div class="login_btn">
                <div @click="warn_confirm" class="login_confirm">
                    {{ lang.PopupCommon_Sure }}
                </div>
            </div>
        </div>
        ...
        <div v-show="modifyPopShow" class="login_outPop">
            ...
            <div class="login_btn">
                <div @click="lock_confirm" class="login_confirm">
                    {{ lang.PopupCommon_Sure }}
                </div>
            </div>
        </div>
        ...
        <div v-show="modifyShow" class="modify_pop">
            ...
            <div class="modify_conter">
                ...
                <div class="New_password">
                    ...
                    <div class="ipt2">
                        <el-input show-password v-model="New_password"
                            :placeholder="lang.AboutUsView_PEPassword"></el-input>
                    </div>
                </div>
                <div class="confirm_password">
                    <div class="text3">
                        {{ lang.AboutUsView_ConfirmPassword }}
                    </div>
                    <div class="ipt3">
                ...
                <div class="modify_fool">
                    <div @click="modify_confim" class="modify_Btnconfim">
                        {{ lang.PopupCommon_Sure }}
                    </div>
                    <div @click="closeFun" class="modify_Btncencel">
        ...
        <div v-show="faultPopUpShow && faultPopUpList.length" class="login_outPop2">
            <div class="login_outHead">
                <i class="warning el-icon-warning"></i>
                <span class="text">{{ lang.Main_MessageBox_Title_Tips }}</span>
            </div>
            <div class="login_conter2">
                <div v-for="(item, _idx) in faultPopUpList" :key="_idx">
                    {{ item }}
                </div>
            </div>
            <div class="login_btn">
                <div @click="closeFaultPopUpShow" class="login_confirm">
                    {{ lang.PopupCommon_Sure }}
                </div>
            </div>
        </div>
...
export default {
    data() {
        return {
            ...
            loginShow1: false,
            warnPopShow: false,
            faultPopUpShow: false,
            faultPopUpShowTime: '',
            faultPopUpList: [],
            tempfaultPopUpString: '',
            faultPopUpTimer: 0,
            userid: '',
            routerShow: true,
    ...
    mounted() {
        this.faultPopUpShowTime = new Date().getTime();
        this.checkFaultPopUpShowTime();
        // this.$nextTick(() => {
        ...
        if (this.color == 'white') {
            this.selectradio = 'white';
        } else if (this.color == 'grey') {
            this.selectradio = 'grey';
        } else {
            this.selectradio = 'blackBlue';
        }
        this.routerAxio();
        var userinfo = JSON.parse(sessionStorage.getItem('userInfo1'));
        if (userinfo == null) {
            this.userid = '';
            this.$refs.user_infoImg.src =
                this.$store.state.color === 'blackBlue'
                    ? require('../../assets/images/icon_user_info_black_blue.png')
                    : require('../../assets/images/icon_user_info.png');
        } else {
    ...
    methods: {
        closeFaultPopUpShow() {
            this.faultPopUpShow = false;
            this.faultPopUpList = [];
            this.faultPopUpShowTime = new Date().getTime(); //重置一小时时间
            this.checkFaultPopUpShowTime();
        },
        checkFaultPopUpShowTime() {

            clearTimeout(this.faultPopUpTimer);
            this.faultPopUpTimer = setTimeout(() => {
                this.$axios({
                    //权限配置请求接口
                    method: 'get',
                    url: '/api/KilnFault/KilnFaultQuery',
                }).then((res) => {
                    this.faultPopUpList = res.data.data;
                    let str = res.data.data.join('');
                    let time = new Date().getTime() - this.faultPopUpShowTime;
                    console.log('time', time);
                    //看看够一小时没，一小时不论变不变化都再弹一次
                    if (time >= 3600000) {
                        //查询弹窗
                        this.tempfaultPopUpString = str; //弹出时记录本次是个啥，下轮作为比对是否变化
                        let isBSystem = eval(sessionStorage.getItem('isBSystem'));
                        if (isBSystem) {
                            return
                        }
                        this.faultPopUpShow = true;
                    } else if (str != this.tempfaultPopUpString) {
                        //文本不同
                        this.tempfaultPopUpString = str; //弹出时记录本次是个啥，下轮作为比对是否变化
                        let isBSystem = eval(sessionStorage.getItem('isBSystem'));
                        if (isBSystem) {
        ...
        getLocalData() {
            ...
            let currentLang = localStorage.getItem('currentLang');
            this.localData.Main_Record_SoftwareInfo =
                languages[currentLang].Main_Record_SoftwareInfo;
            this.localData.Main_Record_Logout =
                languages[currentLang].Main_Record_Logout;
            this.localData.SuperAdmin = languages[currentLang].SuperAdmin;
            this.localData.Main_Record_ChangePassword =
                languages[currentLang].Main_Record_ChangePassword;
        },
        changemenu() {
        ...
        msgHubFun() {
            ...
            var self = this;
            //plc
            window.$.connection.tianLuHub.client.PLCSentData = function (
                content
            ) {
                setTimeout(() => {
                    self.$store.state.PLCCount = content;
                }, 50);
            };

            //二次开发图表实时刷新调用客户端方法 接收值
            window.$.connection.subchart.client.ReceivedRealyData = function (
                content
            ) {
                setTimeout(() => {
                    //同时调用多次会直接替换延迟50毫秒保证每次替换的值都有被监听到
            ...
            window.$.connection.subchart.client.ReceivedQueryData = function (
                content
            ) {
                setTimeout(() => {
            ...
            window.$.connection.redisMonitor.client.ReceivedAlarms = function (
                name,
                value
            ) {
                let data = {
            ...
            window.$.connection.redisMonitor.client.RegistDeviceMessageRemind =
                (content) => {
                    console.log('这是RegistDeviceMessageRemind方法:', content);
                };
            //主页面报警提醒消息实时值调用方法 接收值
            window.$.connection.redisMonitor.client.ReceivedDeviceMessageRemind =
                (content) => {
                    this.vulnerablePartNum =
                        content.vulnerablePartNum > 99
                            ? '99+'
                            : content.vulnerablePartNum;
                    this.pointInspectionNum =
                        content.pointInspectionNum > 99
                            ? '99+'
                            : content.pointInspectionNum;
                    this.maintainNum =
                        content.vulnerablePartNum > 99
                            ? '99+'
                            : content.maintainNum;
                    this.repairNum =
                        content.repairNum > 99 ? '99+' : content.repairNum;
                    var TotalNum =
                        content.vulnerablePartNum +
                        content.pointInspectionNum +
                        content.maintainNum +
                    ...
                    if (this.TotalNum == 0) {
                        ...
                        if (
                            document.querySelector('.warn_infoImg') != undefined
                        ) {
                            document.querySelector('.warn_infoImg').src =
                                this.$store.state.color === 'blackBlue'
                                    ? require('../../assets/images/warn_black_blue.png')
                                    : require('../../assets/images/6d9a1ee3e274d5e414e1475c0bae615.png');
                            document.querySelector(
                                '.warn_text'
                            ).style.background = '#999';
                            document.querySelector('.warn_text').innerHTML =
                                this.TotalNum;
                        }
                    } else {
                        this.TotalNum = this.TotalNum;
            ...
            //二次开发页面脚本事件调用方法
            window.$.connection.chart.client.ReceivedExecuteScript = function (
                name,
                value
            ) {
                //              name = [
            ...
            //二次开发页面实时监听变量点 接收值
            window.$.connection.redisMonitor.client.RecivedRedisChanged =
                function (name, value) {
            ...
            this.$axios({
                ...
                .then((res) => {
                    ...
                    if (res.data.data.HasConfig == 1) {
                        ...
                        document.querySelector(
                            '.logo'
                        ).src = `/images/${res.data.data.Config.TitleLogo}`;
                        this.wareTitleText = res.data.data.Config.InfoText;
                        document.querySelector(
                            '.software_img'
                        ).src = `/images/${res.data.data.Config.PropagandaLogo}`;
                    }
                })
                .catch((err) => {
                    console.log('err', err);
        ...
        login() {
            ...
            if (userinfo == null) {
                ...
                this.userName1 =
                    userinfo.SCMSUserName == 'SuperAdmin'
                        ? this.localData.SuperAdmin
                        : userinfo.SCMSUserName;
                this.loginShow = true;
            }
        },
        //修改密码
            ...
            this.$axios({
                ...
                .then((res) => {
                    ...
                    if (res.data.code == 1) {
                        ...
                        this.modifyText =
                            this.lang.AboutUsView_HT_PasswordHasUpdated;
                    }
                })
                .catch((err) => {
        ...
        login_yes() {
            ...
            sessionStorage.setItem('isBSystem', null);
            localStorage.setItem('tourist', this.tt);
            this.$refs.user_infoImg.src =
                this.$store.state.color === 'blackBlue'
                    ? require('../../assets/images/icon_user_info_black_blue.png')
        ...
        blackBlue() {
            this.selectradio = 'blackBlue';
            this.$store.state.color = 'blackBlue';
            this.$store.commit('changecolor', 'blackBlue');
            localStorage.setItem('theme', 'blackBlue');
        },
        //关闭皮肤弹窗
        yifu1() {
            this.yifu = false;
                    ...
                    if (ress.data.code == 0) {
                        ...
                        ress.data.data.forEach((item, index) => {
                            if (
                                ...
                                item.permission === 'VariableMonitor'
                            ) {
                        ...
                        if (this.Menus.length != 0) {
                            if (this.$route.path == '/onePath') {
                                ...
                                var oneId;
                                if (
                                    ress.data.data[0].children == null ||
                                    ress.data.data[0].children.length == 0
                                ) {
                                ...
                                console.log('onePath', onePath, oneId);
                                this.$router.push({
                                    path: onePath,
                                    query: { id: oneId },
                                });
                            ...
                            for (
                                let m = 0;
                                m < $('.header-nav').find('.nav-item').length;
                                m++
                            ) {
                                console.log(
                                    $('.header-nav').find('.nav-item')[m]
                                );
                            }
                            console.log($($('.header-nav')[0]).children());
                            console.log('MenusArr', MenusArr);
                            let a11111 = Number(
                                parseFloat(window.screen.width / 1920).toFixed(
                                    2
                                )
                            );
                            if (a11111 < 1) {
                            ...
                            document.querySelector('.header-nav2').style.width =
                                MenusSum2 + 'px';

                            this.$nextTick(function () {
                                if (this.$route.path == '/onePath') {
                                    this.nowchildrem =
                                        this.Menus[0].children[0].title;
                                    ...
                                    for (
                                        ...
                                        if (this.Menus[i].path) {
                                            ...
                                            for (
                                                let j = 0;
                                                j <
                                                this.Menus[i].children.length;
                                                j++
                                            ) {
                                                if (
                                                    this.$route.path ==
                                                    this.Menus[i].children[j].to
                                                ) {
                                                    this.now =
                                                        this.Menus[i].title;
                                                    this.nowchildrem =
...
.blackBlueBg {
    ...
    .login_pop {
        ...
        .login_row2 {
            ...
            .loginImg {
                width: 19px;
                height: 19px;
                background: url('../../assets/images/login_porper2_black_blue.png');
                background-size: cover;
                margin-left: 5px;
                margin-right: 8px;
            }
    ...
    .software {
        ...
        .software_conter .software_text {
            color: #fff;
        }

        .software_fool {
            .software_img2 {
                background: url('../../assets/images/syclogo_black_blue.png');
                background-size: cover;
            }
        }
    }

    ...
    >
        <div @click="warnIfon1" class="v-toolbar__content">
            <div class="header-top">
                ...
                >
                    <ul>
                        <li @click="appdownloadcode('移动端下载')">
                            {{ lang.AppDownload }}
                        </li>
                        <li @click="appdownloadcode('工程码')">
                            {{ lang.EngineeringCode }}
                        </li>
                    </ul>
                </div>
                        ...
                        >
                            <router-link
                                ...
                                :to="{
                                    ...
                                    query: {
                                        id:
                                            newItem.id /* , title: newItem.title  */
                                    }
                                }"
                                v-if="item.children"
                                :class="{
        ...
        >
            ...
            >
                <!-- <span>{{lang.AboutUsView_AboutSoftWare}}</span> -->
                <span :class="{ colordiv1: $store.state.color == 'grey' }">{{
                    appTitle
                }}</span>
                <i
                    ...
                    <div class="app-conter-body">
                        <div v-show="!apptype" class="app-android-class">
                            ...
                            <div class="app-android-btn">
                                ...
                                <div
                                    class="app-btn-keepimg"
                                    @click.stop="keepImgFun(0)"
                                >
                                    {{ lang.SavePicture }}
                                </div>
                            </div>
                ...
                >
                    <div class="app-android-class engineering-top">
                        <div class="app-engineering-img">
                            ...
                            <div class="app-engineering-text">
                                {{ engineeringName }}
                            </div>
                        </div>
                        <div class="engineering-tips">
                            {{ lang.DownloadApp_ToCheck }}
                        </div>
                        <div class="app-android-btn">
                            <!-- <div class="app-btn-copyimg">{{lang.CopyPicture}}</div> -->
                            <div
                                class="app-btn-keepimg"
                                @click.stop="keepImgFun(3)"
                            >
                                {{ lang.SavePicture }}
                            </div>
                        </div>
    ...
    methods: {
        getdropLang() {
            this.$axios({
                ...
                if (
                    !langValue ||
                    !res.data.data.find(_ => _.value == langValue)
                ) {
                    localStorage.setItem(
                        'currentLang',
        ...
        keepImgFun(type) {
            if (type == 0) {
                ...
                this.downloadIamge(
                    '/api/data/doget?url=' + this.engineeringImgUrl,
                    'CMS-engineering'
                );
            }
        },
            ...
            if (type == '移动端下载') {
                ...
                this.$axios({
                    ...
                    this.engineeringImgUrl =
                        'http://' +
                        ServiceAddress +
                        '/api/View/GetProjectQrCode?projectName=' +
                        projectName +
                        '&includeIcon=True&transparent=False';
        ...
        msgHubFun() {
            ...
            try {
                ...
                window.$.connection.subchart.client.ReceivedClearCurveGroupId = function(
                    content
                ) {
                    setTimeout(() => {
                        //同时调用多次会直接替换延迟50毫秒保证每次替换的值都有被监听到
            ...
            try {
                window.$.connection.redisMonitor.client.RecivedRedisControlChanged = function(
                    name,
                    value,
                    arr,
                    b
            ...
            try {
                //静态图片接收值
                window.$.connection.staticImageHub.client.updateWebStaticImages = function(
                    data
                ) {
            ...
            try {
                //二次开发页面实时监听变量点 接收值
                window.$.connection.redisMonitor.client.RecivedRedisChanged = function(
                    name,
                    value
                ) {
        ...
        login_yes() {
            ...
            var name = JSON.parse(sessionStorage.getItem('userInfo1'))
                .SCMSUserName;
            ...
            await this.$axios({
                ...
                .then(ress => {
                    ...
                    this.$axios({
                        ...
                        this.$store.state.user = sightseerInfo;
                    });
                    //缓存请求全部的菜单信息
                    this.$axios({
                        method: 'post',

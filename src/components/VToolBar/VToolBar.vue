    ...
    >
        <div @click="warnIfon1" class="v-toolbar__content">
            <div class="header-top">
                ...
                <div class="header-screen" @click.stop="screenchange">
                    <img
                        src="../../assets/images/tv_black_blue.png"
                        alt
                ...
                >
                    <ul>
                        <li @click="activechange('one')">
                            ...
                            <img
                                v-else
                                src="../../assets/images/screen_normal.png"
                                alt
                            />
                        ...
                        <li @click="activechange('two')">
                            <img
                                v-if="activeli == 'two'"
                                src="../../assets/images/original_selected.png"
                                alt
                            />
                            <img
                                v-else
                                src="../../assets/images/original_normal.png"
                                alt
                            />
                        ...
                        <li @click="activechange('three')">
                            <img
                                v-if="activeli == 'three'"
                                src="../../assets/images/width_selected.png"
                                alt
                            />
                            <img
                                v-else
                                src="../../assets/images/width_normal.png"
                                alt
                            />
                        ...
                        <li @click="activechange('four')">
                            ...
                            <img
                                v-else
                                src="../../assets/images/hight_normal.png"
                                alt
                            />
                ...
                <div class="warn-info1" @click.stop="yifuchange">
                    <img
                        src="../../assets/images/yifu_black_blue.png"
                        ref="warn_infoImg"
                        alt
                        v-if="$store.state.color == 'blackBlue'"
                    />
                    <img
                        src="../../assets/images/yifu.png"
                        ref="warn_infoImg"
                        v-else
                    />
                </div>
            ...
            <div class="header-nav">
                ...
                >
                    <router-link
                        ...
                        :to="{ path: item.to, query: { id: item.id } }"
        ...
        <div v-show="loginShow1" class="login_outPop">
            ...
            <div class="login_conter">
                <div>
                    {{
                        `${lang.Main_MessageBox_IfLoginOut} &lt;${
                            userName1 == lang.SuperAdmin
                                ? 'SuperAdmin'
                                : userName1
                        }&gt; ?`
                    }}
        ...
        <div
            v-show="faultPopUpShow && faultPopUpList.length"
            class="login_outPop2"
        >
            <div class="login_outHead">
                <i class="warning el-icon-warning"></i>

...
<template>
  <div>
    <el-dialog :title="titleType + '器件信息'" width="800px" class="create-device flex" :visible.sync="dialogVisible"
        ...
        <el-form ref="myform" class="from" :model="formData" label-width="90px">
          <el-row>
            <el-col :span="24" class="title flex">
              <div class="block"></div>
              <div class="text">{{ lang.EquipmentAccount_BasicInformation }}</div>
              <div class="lin"></div>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="lang.EquipmentAccount_VulnerablePartName">
                <el-input v-model="formData.VulnerablePartName"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="lang.EquipmentAccount_VulnerablePartNo">
                <el-input v-model="formData.VulnerablePartNo"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="lang.EquipmentAccount_UsingDevice">
                <div class="layout-1">
                  <el-input v-model="formData.UsingDevice" disabled
                    :placeholder="lang.EquipmentAccount_ClickSelect"></el-input>
                  <img @click="() => { associationDeviceConfig.state = 'show' }" :src="icons.diji" class="icon" />
                </div>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="lang.VulnerablePartManage_VulnerablePartType">
          ...
          <el-row>
            <el-col :span="24" class="title flex">
              <div class="block"></div>
              <div class="text">{{ lang.VulnerablePartManage_LifeInfo }}</div>
              <div class="lin"></div>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="lang.EquipmentAccount_StartDate" prop="EnableTime">
                <el-date-picker v-model="formData.EnableTime" type="datetime" value-format="yyyy-MM-dd HH:mm:ss"
                  format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="lang.EquipmentAccount_TimerType">
                <el-select v-model="formData.SelectedTimerType">
                  <el-option v-for="item in options.statisticalType" :key="item.value" :label="item.label"
                    :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item :label="lang.EquipmentAccount_LifeCycle">
                <div class="layout-2">
            ...
            <el-col :span="12">
              <el-form-item :label="lang.EquipmentAccount_RunningSignal">
                <div class="layout-1">
                  <el-input v-model="formData.RunningSignal" disabled
                    :placeholder="lang.EquipmentAccount_ClickSelect"></el-input>
            ...
            <el-col :span="12" class="coefficient" v-show="formData.SelectedTimerType === 3">
              <i class="el-icon-question" :title="lang.VulnerablePartManage_UsedTimetips"></i>
              <el-form-item :label="lang.VulnerablePartManage_StatisticalCoefficient">
                <el-input-number v-model="formData.Coefficient" :min="0"></el-input-number>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="lang.EquipmentAccount_AdvanceReminder">
                <div class="layout-2">
            ...
            <el-col :span="12">
              <el-form-item :label="lang.PointInspectionManage_Executor">
                <el-select v-model="formData.Executor">
                  <el-option v-for="item in options.userList" :key="item" :label="item" :value="item">
                  </el-option>
                </el-select>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col :span="24" class="title flex">
              <div class="block"></div>
              <div class="text">{{ lang.EquipmentAccount_OtherInformation }}</div>
              <div class="lin"></div>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="lang.EquipmentAccount_UseNumber">
                <el-input v-model="formData.UseNumber"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="lang.EquipmentAccount_DevicePrice">
                <el-input v-model="formData.Price"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item :label="lang.EquipmentAccount_Supplier">
                <el-input v-model="formData.Manufactor"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item :label="lang.EquipmentAccount_DeviceRemark">
                <el-input v-model="formData.Remarks" type="textarea" :rows="4"
                  :placeholder="lang.VulnerablePartManage_RemarkDescription"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      formData2: { // 还原数据用
        ...
        EnableTime: '', // 启用日期
        SelectedTimerType: 1, // 统计类型 标准-1 运行-2 次数-3
        LifeCycleValue: '', // 寿命周期-值
        LifeCycleUnit: 1, // 寿命周期-单位
        RunningSignal: '', // 统计信号
        Coefficient: '', // 统计系数
        ReminderTimeValue: '', // 提前提醒-值
        ReminderTimeUnit: 1, // 提前提醒-单位
        Executor: '', // 执行人
  ...
  methods: {
    ...
    selectVariableShow() {
      // 统计类型为标准时间，统计信号不可选择
      if (this.formData.SelectedTimerType === 1) {
    ...
    submit(type) {
      ...
      // if (window) return
      this.$api.agency.saveAcount({
        ...this.formData,
        CoefficientValue: this.formData.Coefficient
      }).then(ref => {
    ...
    setFormData() {
      ...
      } else if (!newData.RunningSignal) {
        newData.SelectedTimerType = 1
      } else {
        newData.SelectedTimerType = 2
      }
      ...
      if (this.state === 'edit') {
        ...
        console.log('this.newData ', newData.LifeCycleUnit)
        this.formData = { ...newData, Coefficient: newData.CoefficientValue }
        console.log('this.formData 0', this.formData.LifeCycleUnit)
    ...
    "formData.SelectedTimerType": {
      handler: function (value) {
        ...
        if (value === 3) {
          ...
          this.formData.LifeCycleUnit = 1
          this.formData.ReminderTimeUnit = 1

        ...
        <div class="myDialog" id="myDialog">
            ...
            <div class="popContent">
                <el-table ref="projTable" highlight-current-row :cell-style="{ borderColor: '#E4E7ED' }"
                    ...
                    <el-table-column prop="StatuName" label="设备状态" :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                            <el-input :maxLength="40" v-model="scope.row.StatuName" />
                        </template>
                    </el-table-column>
...
export default {
    ...
    methods: {
        changeSort(row, isUp) {
            ...
            if (_idx >= this.dataList.length - 1) {
                _idx = this.dataList.length - 1
            }
            if (_idx <= 0) {
                _idx = 0
            }
            ...
            this.$nextTick(() => {
                this.dataList = list;
                this.$nextTick(() => {
                    this.$refs.projTable.setCurrentRow(this.dataList[this.curIdx]);
                })
            })
        },

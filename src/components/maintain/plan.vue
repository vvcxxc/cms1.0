...
<template>
    <div class="public-table bygl"  @click="changeselect = false"     v-loading="this.$store.state.isShow"
        ...
        <div class="look" v-show="offdecive"  :style="{width:1120*zoom+'px',height:600*zoom+'px'}">
            ...
            ></div>
            <div class="lookhead" :style="{height:60*zoom+'px',lineHeight:60*zoom+'px',fontSize:18*zoom+'px'}" :class="[{colordiv:$store.state.color=='grey'},{fcolor:$store.state.color=='grey'}]">
            ...
            <div class="lookcontent" @click="selectword3 = false">
             ...
             <div class="seleword1">
               ...
               <img :src="xiala" alt />
                    ...
                    <div class="table" :style="{width:950*zoom+'px',height:360*zoom+'px'}">
                        <el-table
        ...
        <div class="search-container" :style="{
            ...
            <div class="sad" @click="sad" >{{lang.UserManage_Query}}</div>
            <div class="add" @click="add" >{{lang.UserManage_Add}}</div>
            <div class="move" @click="del" >{{lang.UserManage_Delete}}</div>
        </div>
        <div class="table-container table-container1">
            ...
            >
                ...
                <el-table-column type="selection" :width="zoom>1?60*zoom:60" :show-overflow-tooltip="true" fixed></el-table-column>
                ...
                <el-table-column prop="name" :label="lang.UserManage_Operation" :width="200*zoom"  fixed>
                ...
                <el-table-column
                   ...
                   :show-overflow-tooltip="true"
                ></el-table-column>
                <el-table-column prop="IsEnabled" :label="lang.MaintenanceManage_PlanExecutionStatus"   :width="300*zoom" :show-overflow-tooltip="true"></el-table-column>
                <el-table-column
                    prop="NextStartTime"
                ...
                <el-table-column
                  ...
                  :width="300*zoom"
                   :show-overflow-tooltip="true"
                ></el-table-column>
                <el-table-column prop="DeviceName" :label="lang.EquipmentAccount_EquipmentName" :width="300*zoom" :show-overflow-tooltip="true"></el-table-column>
                <el-table-column
        ...
        <!-- <div class="sestion sestion1" ref="kongtiao1" :class="{yd:pdyd2}" v-if="changetrue"> -->
            <div class="sestionheader"   :class="{colordiv:$store.state.color=='grey'}" >
                ...
                ></div>
                <span class="head" v-if="sestion == 1"   :class="{fcolor:$store.state.color=='grey'}">{{lang.MaintenanceManage_AddMaintenancePlan}}</span>
                <span class="head" v-else-if="sestion == 2"   :class="{fcolor:$store.state.color=='grey'}">{{lang.MaintenanceManage_ViewMaintenancePlan}}</span>
                <span class="head" v-else-if="sestion == 3"   :class="{fcolor:$store.state.color=='grey'}">{{lang.SCMSConsoleWebApiMySql_EditMaintenancePlan}}</span>
                ...
                <div class="overflow" >
                    <div class="zl">
                        <div class="margin" >
                            ...
                            <!-- <input type="text" v-if="sestion == 3" v-model="wantnowdata.TaskName" /> -->
                            <!-- <div class="margin">
                                <span style="margin-right:45px;">{{lang.EquipmentAccount_EquipmentName}}</span>
                        ...
                        <div class="margin">
                            <span >{{lang.MaintenanceManage_TaskStartTime}}</span>
                            <template>
                        ...
                        <div class="margin" >
                            ...
                            <div class="is">
                                <input type="text" v-if="sestion == 1" v-model="meaddtable.PeriodValue" />
                                <input type="text" v-if="sestion == 2" v-model="meaddtable.PeriodValue" disabled />
                                <input type="text" v-if="sestion == 3" v-model="meaddtable.PeriodValue" />
                                ...
                                <select name id v-model="meaddtable.PeriodUnit" v-if="sestion == 2" disabled >
                                    <option v-for="(item,index) in sametimearr" :key="index" :value="item">{{item}}</option>
                                </select>
                    ...
                    <div class="zr">
                        <div class="margin"  >
                            ...
                            <select
                                name
                                id
                                v-model="meaddtable.MaintenancePerson "
                                v-if="sestion == 1" 
                            >
                                <option
                                    :value="item"
                        ...
                        <div class="margin" >
                            ...
                            <div class="is">
                                ...
                                <select name id @change="endValue()" v-model="meaddtable.endTimeUnit" v-if="sestion == 1" >
                                    <option v-for="(item,index) in sametimearr" :key="index" :value="item">{{item}}</option>
                                </select>
                                <select name id @change="endValue()" v-model="meaddtable.endTimeUnit" v-if="sestion == 2" disabled >
                                    <option v-for="(item,index) in sametimearr" :key="index" :value="item">{{item}}</option>
                                </select>
                    ...
                    <div class="overflow overflow1" >
                        <span class="overflow-remarks">{{lang.MaintenanceManage_TaskExecutionContent}}</span>
                        <textarea name id v-if="sestion == 1"  v-model="meaddtable.Remarks"
                            ></textarea>
                        <textarea
                            name
                            id
        ...
        <div class="cover5" v-if="changetrue"></div>
    </div>
</template>
    ...
    created() {
     ...
     console.log("but",this.buttonarr)
        this.buttonarr.forEach((item)=>{
         if(item.RightName == "保养计划-查询按钮"){
          this.cxid = item.RightID
         }else if(item.RightName == "保养计划-添加按钮"){
          this.tjid = item.RightID
         }else if(item.RightName ==  "保养计划-删除按钮"){
          this.scid = item.RightID
         }else if(item.RightName ==  "保养计划-查看按钮"){
          this.ckid = item.RightID
         }else if(item.RightName == "保养计划-编辑按钮"){
 ...
 computed:{
    ...
    methods: {
        getLangData() {
            ...
            this.meaddtable.endTimeUnit = this.lang.HMI_HT_LineChartWindowViewModel_Hour
...
for(let i=0;i<$('.atooltip').length;i++){
        ...
        //结束时间计算
        endValue(){
            console.log('eee',this.meaddtable.CurrentStartTime)
            if(this.meaddtable.endTimeUnit == this.lang.HMI_HT_LineChartWindowViewModel_Hour){
                this.meaddtable.CurrentEndTime = 
                moment(this.meaddtable.CurrentStartTime).add(Number(this.meaddtable.EndTimeValue),"hours").format("YYYY-MM-DD HH:mm:ss")
            }else if(this.meaddtable.endTimeUnit == this.lang.MaintenanceManage_Day){
                this.meaddtable.CurrentEndTime = 
                moment(this.meaddtable.CurrentStartTime).add(Number(this.meaddtable.EndTimeValue),"days").format("YYYY-MM-DD HH:mm:ss")
            }else if(this.meaddtable.endTimeUnit == this.lang.HMI_HT_LineChartWindowViewModel_Week){
                this.meaddtable.CurrentEndTime = 
                moment(this.meaddtable.CurrentStartTime).add(Number(this.meaddtable.EndTimeValue),"weeks").format("YYYY-MM-DD HH:mm:ss")
            }else if(this.meaddtable.endTimeUnit == this.lang.HMI_HT_LineChartWindowViewModel_Month){
                this.meaddtable.CurrentEndTime= 
                moment(this.meaddtable.CurrentStartTime).add(Number(this.meaddtable.EndTimeValue),"months").format("YYYY-MM-DD HH:mm:ss")
            }
        },
          jump() {
...
this.$store.commit('move')
        ...
        yes1() {
            ...
            this.$axios({
                method: 'post',
                url: `/api/MaintenanceManage/MaintenanceManage_DeletePlan`,
                data: this.argID
            }).then(res => {
                console.log(res);
...
this.$store.commit('move')
        ...
        getdevice() {
            this.$axios
                  .post(`/api/MaintenanceManage/MaintenanceManage_GstEquipmentAccount`)
                .then(res => {
                    console.log(res);
...
this.$store.commit('move')
        ...
        nopre() {
            if (this.sestion == 1) {
                ...
                this.endValue()
              console.log('ee==>',this.meaddtable)
              let postData = {
                  ...this.meaddtable,
                  DeviceName: this.meaddtable.DeviceName === this.lang.EquipmentAccount_ClickSelect ? '' : this.meaddtable.DeviceName
              }
                this.$axios({
                    method: 'post',
                    url: `/api/MaintenanceManage/MaintenanceManage_SavePlan`,
                    data: postData
                }).then(res => {
                          setTimeout(() => {
                            $('.tip').css({
...
this.$store.commit('move')
                    ...
                    if (res.data.msg == '请求成功') {
                        ...
                        this.getsetime();
                    }else if(res.data.msg == /* "设备id格式应为GUID！" */ this.lang.SCMSConsoleWebApiMySql_DeviceIDMustGuid){
                           this.tipword = this.lang.FileManage_SelectEquipmentName;
                             if (this.meaddtable.PeriodUnit == 1) {
                            this.meaddtable.PeriodUnit = this.lang.HMI_HT_LineChartWindowViewModel_Hour;
                        } else if (this.meaddtable.PeriodUnit == 2) {
                            this.meaddtable.PGUeriodUnit = this.lang.MaintenanceManage_Day;
...
this.$store.commit('move')
           ...
           if(cc){
                ...
                this.meaddtable.EndTimeValue = jsvalue
                this.meaddtable.endTimeUnit = this.lang.HMI_HT_LineChartWindowViewModel_Month
           }else{
               if(jsvalue % 168 == 0){
                   this.meaddtable.EndTimeValue = jsvalue / 168
                   this.meaddtable.endTimeUnit = this.lang.HMI_HT_LineChartWindowViewModel_Week
               }else if(jsvalue % 24 == 0){
                   this.meaddtable.EndTimeValue = jsvalue / 24
                   this.meaddtable.endTimeUnit = this.lang.MaintenanceManage_Day
               }else{
                   this.meaddtable.EndTimeValue = jsvalue
                   this.meaddtable.endTimeUnit = this.lang.HMI_HT_LineChartWindowViewModel_Hour
               }
...
this.$store.commit('move')
            ...
            this.sestion = 3;
            console.log(b);
            let a11 = JSON.stringify(b.Remarks);
            this.w = JSON.parse(a11);
            this.meaddtable = b;
            let a1 = JSON.stringify(this.meaddtable.PlanName);
            this.meaddtable.oldPlanName  =  JSON.parse(a1);
            this.meaddtable.PeriodValue = parseInt(this.meaddtable.PeriodValue);
...
this.$store.commit('move')
            ...
            this.meaddtable = {
                ...
                DeviceName: this.lang.EquipmentAccount_ClickSelect,
                 EndTimeValue:'1',
                endTimeUnit: this.lang.HMI_HT_LineChartWindowViewModel_Hour,
            };
            this.meaddtable.CurrentStartTime = this.gettimenowtime();
            this.meaddtable.CurrentStartTime = moment(this.meaddtable.CurrentStartTime).add(1,'hours').format("YYYY-MM-DD HH:mm:ss")
            this.meaddtable.CurrentEndTime = this.gettimenowtime();
            this.meaddtable.MaturityTime = this.gettimenowtime();
            this.meaddtable.MaturityTime = moment(this.meaddtable.MaturityTime).add(1,'weeks').format("YYYY-MM-DD HH:mm:ss")
                setTimeout(() => {
                            $('.sestion1').css({
                                zoom: this.zoom,
                                left: `calc(50% - ${($('.sestion1').width() / 2) *
...
this.$store.commit('move')
        ...
        onetable() {
            ...
            this.$axios
                .post(
                    `/api/MaintenanceManage/MaintenanceManage_GstPlan?argDeviceType=${c}&argStartTime=${this.value1}&argEndTime=${this.value2}&argKeyword=${this.keyword}&argPageSize=${this.PageData.PageSize}&argPageIndex=${this.PageData.PageIndex}`
                )
                .then(res => {
                     if (res.data.code == 0) {
...
for(let i=0;i<$('.el-picker-panel').length;i++){
        ...
        getEquipmentType() {
            this.$axios
                 .post(`/api/MaintenanceManage/MaintenanceManage_GstEquipmentType`)
                .then(res => {
                    this.a1 = 1;
                    this.a2 = 1;
                    this.selectname1 = [
        ...
        req(pageIndex) {
          ...
          getsetime(){
            this.$axios.post(`/api/MaintenanceManage/MaintenanceManage_GstPlanInitTime`).then(res =>{
                console.log("sss",res)
             ...
             new Date(new Date().toLocaleDateString()).getTime() +
                ...
                this.value2 =  this.GMTToStr(new Date(new Date().toLocaleDateString()).getTime() +
                    24 * 60 * 60 * 1000 -
                    1)
    ...
    mounted() {
        ...
        this.$store.state.zoom = this.zoom
let that = this;

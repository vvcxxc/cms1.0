...
<template>
    <section class="page-container">
        <div class="left" :style="{zoom:(a-0.22)}">
        ...
        <div class="right" :style="{zoom:(a-0.22)}">
            <div class="btn" @click="jump('first')">{{localData.DataGrid_Reaction_FirstPage}}</div>
            <div class="btn" @click="jump('prev')"  :class="{nopage:!pageData.LastEnabled}" >{{localData.DataGrid_Reaction_LastPage}}</div>
            <div class="btn" @click="jump('next')"  :class="{nopage:!pageData.NextEnabled}" >{{localData.DataGrid_Reaction_NextPage}}</div>
            <div class="btn" @click="jump('last')">{{localData.DataGrid_Reaction_EndPage}}</div>
            <div class="input">
                {{localData.DataGrid_Reaction_The}}
                <el-input class="pages" v-model="targetPage"></el-input>{{localData.DataGrid_Reaction_Page}}
            </div>
            <div class="btn" @click="jump('jump')">{{localData.DataGrid_Reaction_TurnPage}}</div>
        </div>
    </section>
</template>

            ...
            >
                <template slot-scope="scope">
                    <div
                        ...
                        v-show="scope.row.UserAccount !== 'SuperAdmin'"
                    >
                        <img :src="pensoil" alt />
                        <!-- {{scope.row.phone}} -->
                    </div>
                    <div
                        ...
                        v-show="
                            scope.row.UserAccount !== 'SuperAdmin' &&
                                scope.row.UserAccount !== 'guest'
                        "
                    >
                        <img :src="dell" alt />
                    </div>
...
export default {
    ...
    watch: {
        VpowerData(val) {
            ...
            if (
                this.searchList[0].placeholder == this.lang.RoleManage_QueryInfo
            ) {

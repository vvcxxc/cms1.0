...
<template>
    <div class="search-container">
        <div class="search-left">
            ...
            <div class="btn search" @click="search">{{lang.RoleManage_Query}}</div>
            <div class="btn add" @click="search">{{lang.RoleManage_Add}}</div>
            <div class="btn del" @click="search">{{lang.RoleManage_Delete}}</div>
            <div class="btn  important" @click="search">{{lang.QualityManage_SampleChoseUserControl_Import}}</div>
            <div class="btn  important" @click="search">{{lang.QualityManage_SampleChoseUserControl_Export}}</div>
        </div>
        <!-- <div class="fr">

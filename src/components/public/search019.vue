        ...
        <div class="search-left">
            <div class="search-item" v-for="(item, index) in searchList" :key="index">
                ...
                <el-date-picker @focus='sx' :style="[
                    ...
                    { fontSize: 16 * 1 + 'px' },
                    { width: 210 * 1 + 'px' }
                ]" v-if="item.type === 'datetimerange'" v-model="searchData[item.model]" type="datetimerange" range-separator="-"
            ...
            <div class="btn green pointer" @click="editFn" :id="cxid">
                开始投料
            </div>
            <div class="btn green pointer" @click="backFn" :id="cxid">
                投料撤回
            </div>
            <div class="btn grey pointer" @click="delFn" :id="cxid">
                删除
            </div>
        </div>
        <!-- <div class="fr">

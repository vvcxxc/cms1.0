    ...
    <div class="search-container">
        <div class="search-left">
            <div class="search-item" v-for="(item, index) in searchList" :key="index">
                ...
                <div class="cs" v-if="item.title == '报警类型：'"></div>
                <el-date-picker
                    v-if="item.type === 'time'"
                    v-model="searchData[item.model]"
                    type="datetime"
            ...
            <div class="btn pointer export" @click="exportTable">{{lang.QualityManage_SampleChoseUserControl_Export}}</div>
        </div>
        <!-- <div class="fr">
...
// .search-left:nth-child(1){
//     // margin-left: 100px !important;
//     display: none;
// }
.search-left:nth-child(4){
    display: none;
}
.cs{
    margin-right: 250px;

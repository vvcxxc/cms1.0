...
<script>
import MySearch from '../public/search55.vue';
import MyTable from '../public/table01.vue';
...
export default {
    ...
    methods: {
        ...
        req(pageIndex) {
            ...
            let a = '';
            if (params.argStatus == this.lang.LogManage_HT_Unlimited) {
                a = '';

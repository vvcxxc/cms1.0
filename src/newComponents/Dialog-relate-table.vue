  ...
  >
    <div class="wrap" >
      ...
      <div class="wrap_middle">
        <el-button class="common_mini_button common_button_add" @click="addToReceiveData">{{lang.RoleManage_Add}}</el-button>
        <el-button class="common_mini_button common_button_remove" @click="removeReceiveData">{{lang.UserManage_DomainText2}}</el-button>
      </div>

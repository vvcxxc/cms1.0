                ...
                $(o).find("tr").not(e.settings.exclude).each(function (i,p) {
                    ...
                    $(p).find("td,th").not(e.settings.exclude).each(function (i,q) { // p did not exist, I corrected
                        ...
                        if(e.settings.preserveColors){
                        	...
                        	additionalStyles += (compStyle && compStyle.backgroundColor ? "background-color: " + compStyle.backgroundColor + ";" : "");
                            additionalStyles += (compStyle && compStyle.color ? "color: " + compStyle.color + ";" : "");
                            additionalStyles += (compStyle && compStyle.align ? "text-align: " + "center" + ";" : "text-align: " + "center" + ";" );
							additionalStyles += (compStyle && compStyle.display ? "display: " + compStyle.display + ";" : "");
						...
						console.log($(this))
                        console.log("wwwwwwwwwwwwwww",additionalStyles)
						console.log("wwwwwwwwwwwwwww1",rc)
                        if( rc.flag.length > 0 ) {

...
import DataItemCollection from './pages/DataItemCollection.vue';
import ProductionLineModeling from './pages/ProductionLineModeling.vue';
export default {
    components: {
        LeftNav,
        ProductionLineModeling,
        DataItemCollection,
    },
    data() {
        return {
            componentName: 'ProductionLineModeling',
            color: '',
            width: 1920,
            zoom: 1
        };
    ...
    methods: {
        tabComponent(index) {
            let componentObj = {
                0: ProductionLineModeling,
                1: DataItemCollection,
            };

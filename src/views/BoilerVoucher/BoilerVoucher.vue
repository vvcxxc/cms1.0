...
import CurrentAlarm from '../materialStagingOrder/materialStagingOrder.vue';
import AlarmPoint from '../boilerGroupFeeding/boilerGroupFeeding.vue';
import HistoryAlarm from '../historicalOrders/historicalOrders.vue';
export default {
	components: {
		LeftNav,
		CurrentAlarm,

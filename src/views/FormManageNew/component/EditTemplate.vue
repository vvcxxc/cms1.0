<template>
    <div class="templatePop">
                    ...
                    <div class="template-item">
                        ...
                        <div class="item-table">
                            <el-table ref="projTable" @row-click="tableRowClickRight" highlight-current-row
                                ...
                                <el-table-column prop="ParameterTypeValue" label="参数类型" :show-overflow-tooltip="true" width="138px">
                                    <template slot-scope="scope">
                                ...
                                <el-table-column prop="DataType" label="变量类型"
                                    :show-overflow-tooltip="true" width="180px"></el-table-column>
        ...
        <VariableSelect v-if="isVariableShow" :data="chooseArr" multiple="true" @variableSelectCallBack="variableSelectCallBack" />
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        tipCallBack(str) {
            ...
            if (str == 'yes') {
                if (this.delType == 1) {
                    const TID = this.tempList[this.curLeft.$index].TID
                    this.tempList.splice(this.curLeft.$index, 1)
                    this.$axios({
                        method: 'post',
                        url: `/api/FormulaManage/FormulaManage_DelFormulaTemplate?argTId=${TID}`,
                    })
                ...
                if (Array.isArray(val)) {
                    val.forEach(item => {
                        this.curLeft.Projects.push({
                            ...
                            ProjectContent: item.Name,
                            Unit: "",
                            Digit: "",
                            Rule: 0,
                            ProjectDescription: "",
                            VariableDescription: item.Descript,
                            ContentGroup: "",

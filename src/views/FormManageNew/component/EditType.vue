        ...
        <div class="myDialog" id="myDialog">
            ...
            <div class="popContent">
                <el-table ref="projTable" highlight-current-row :cell-style="{ borderColor: '#E4E7ED' }"
                    ...
                    <el-table-column width="200px" prop="ProductTypeCode" label="产品型号" :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                            <el-input :maxLength="40" v-model="scope.row.ProductTypeCode" />
                        </template>
                    </el-table-column>
                    <el-table-column width="200px" prop="ProductTypeName" label="产品名称" :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                            <el-input :maxLength="10" v-model="scope.row.ProductTypeName" />
                        </template>
                    </el-table-column>
                    <el-table-column width="200px" prop="MaterialCode" label="物料编码" :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                            <el-input :maxLength="20" v-model="scope.row.MaterialCode" />
                        </template>
                    </el-table-column>
                    <el-table-column width="200px" prop="ProductColor" label="产品颜色" :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                            <el-input :maxLength="10" v-model="scope.row.ProductColor" />
                        </template>
                    </el-table-column>
                    <el-table-column width="200px" prop="TotalProductCode" label="总产品型号代码" :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                            <el-input :maxLength="10" v-model="scope.row.TotalProductCode" />
                        </template>
                    </el-table-column>
                    <el-table-column width="200px" prop="ModelCondenserAssemblyProductCode" label="冷凝器总成型号代码"
                        :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                            <el-input :maxLength="10" v-model="scope.row.ModelCondenserAssemblyProductCode" />
                        </template>
                    </el-table-column>
                    <el-table-column width="200px" prop="CompressionAssemblyProductCode" label="压缩总成产品型号代码"
                        :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                            <el-input :maxLength="10" v-model="scope.row.CompressionAssemblyProductCode" />
                        </template>
                    </el-table-column>
                </el-table>
            </div>
    ...
    methods: {
        ...
        addProj() {
            this.dataList.push({
                ...
                MaterialCode: '',
                TotalProductCode: '',
                ModelCondenserAssemblyProductCode: '',
                CompressionAssemblyProductCode: '',
            })
        },
        delProj() {
            this.isTipShow = true;
        ...
        handleClick(str) {
            if (str == 'yes') {
                ...
                this.$axios({
                    method: 'post',
                    url: `api/FormulaManage/AddOrEditProductType?loginUserName=${userid}`,
                    data: this.dataList
                })
                    .then(res => {
                        if (res.data.code == 0) {

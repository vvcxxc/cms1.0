...
<template>
    <div class="tapwater">
        <div class="linebox">
            ...
            <div class="tabledata" :style="{width: '100%', height: 'calc(100% - 82px)'}">
                <el-table
                    :data="tableData"
                    height="89%"
                    border
                ...
                >
                    ...
                    <el-table-column prop="Device" label="设备名称" width="260"></el-table-column>
                ...
                <table class="bottomtable" cellspacing="0" celloadding="0" height="6%">
    ...
    methods: {
        ...
        exportTable() {
            require.ensure([], () => {
                ...
                export_json_to_excel(tHeader, data, '设备报表');
            });
        },
        ...
        somethingdata() {
            this.$axios({
                method: 'post',
                url: `api/ReportStatistics/ReportStatistics_GstData?argWorkShop=${this.indexId.replace(
                    /#/g,
                    '%23'
        ...
        tablename() {
            ...
            this.$axios({
                method: 'post',
                url:
                    '/api/ReportStatistics/ReportStatistics_GstWorkShopsAndDevices'
            })
                .then(res => {

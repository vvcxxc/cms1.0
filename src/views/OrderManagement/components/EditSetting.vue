    ...
    <div class="zdeditPop">
        <div class="myDialog" id="myDialog">
            ...
            <div class="popContent">
                <el-radio-group v-model="FormualMode" class="ml-4">
                    <el-radio :label="0">动态切换配方</el-radio>
                    <el-radio :label="1">整线下发配方</el-radio>
                </el-radio-group>
            </div>
            <div class="popBtn">
...
export default {
    ...
    mounted() {
        ...
        this.$axios({
            url: `/api/Order/QuerySettingSwitch`,
            method: 'get',
        }).then((res) => {
            if (res.data.code == 0) {
                this.FormualMode = res.data.data.IsWholeLineSwitch
            } else {
    ...
    methods: {
        ...
        handleClick(str) {
            if (str == 'yes') {
                this.$axios({
                    url: `/api/Order/SettingSwitch?AllowSwitch=${this.FormualMode}`,
                    method: 'get',
                }).then((res) => {
                    if (res.data.code == 0) {

            ...
            <div class="query-table clearfix">
                <div class="fl">
                    ...
                    <el-select style="margin-left:5px;width:120px" placeholder="请选择" v-model="type">
                        <el-option label="不限" value="00000000-0000-0000-0000-000000000000">
                        </el-option>
            ...
            <div class="conter">
                <div class="conter-table">
                    <el-table highlight-current-row :cell-style="{ borderColor: '#E4E7ED' }"
                        ...
                        <el-table-column  width="100px" fixed label="工单单号" :show-overflow-tooltip="true">
                        ...
                        <el-table-column width="150px" prop="IsQuantify" label="是否定量生产"
                            :show-overflow-tooltip="true"></el-table-column>
                        ...
                        <el-table-column width="150px" prop="Address" label="产量" :show-overflow-tooltip="true">
                            <template slot-scope="scope">{{ scope.row.Data.OutputNumber }}</template>
                        </el-table-column>
                        <el-table-column width="150px" prop="Address" label="合格数" :show-overflow-tooltip="true">
                            <template slot-scope="scope">{{ scope.row.Data.OkNumber }}</template>
                        </el-table-column>
                        <el-table-column width="150px" prop="Address" label="不合格数" :show-overflow-tooltip="true">
                        ...
                        <el-table-column width="180px" prop="Address" label="计划结束时间" :show-overflow-tooltip="true">
                            <template slot-scope="scope">{{ scope.row.Data.EndTime }}</template>
                        </el-table-column>
                        <el-table-column width="150px" prop="Address" label="备注" :show-overflow-tooltip="true">
                        ...
                        <el-table-column width="180px" label="实际结束时间" :show-overflow-tooltip="true">

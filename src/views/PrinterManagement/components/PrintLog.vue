        ...
        <div class="myDialog" id="myDialog">
            ...
            <div class="popContent">
                ...
                <el-table highlight-current-row :cell-style="{ borderColor: '#E4E7ED' }"
                    ...
                    <el-table-column prop="ContentGroup" label="打印时间" :show-overflow-tooltip="true"></el-table-column>
                    <el-table-column prop="ContentGroup" label="操作人" :show-overflow-tooltip="true"></el-table-column>
                    <el-table-column prop="ContentGroup" label="打印结果" :show-overflow-tooltip="true"></el-table-column>
                </el-table>

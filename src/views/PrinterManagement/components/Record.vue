            ...
            <div class="conter">
                <div class="conter-table">
                    <el-table highlight-current-row :cell-style="{ borderColor: '#E4E7ED' }"
                        ...
                        <el-table-column prop="Device" label="打印内容" :show-overflow-tooltip="true"></el-table-column>
                        <el-table-column prop="Device" label="订单号" :show-overflow-tooltip="true"></el-table-column>
                        <el-table-column prop="Address" label="打印机名称" width="220px"></el-table-column>
                        <el-table-column prop="Address" label="打印机规则" width="220px"></el-table-column>
                        <el-table-column prop="Address" label="创建时间" width="220px"></el-table-column>

        ...
        <div class="table-content" id="table-content">
          <el-table :data="tableData" :span-method="objectSpanMethod" :border="true" style="width: 100%"
            ...
            <el-table-column prop="T1" label="T1" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T1" @blur="isNumber">
                <span v-else>{{ scope.row.T1 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="T2" label="T2" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T2" @blur="isNumber">
                <span v-else>{{ scope.row.T2 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="T3" label="T3" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T3" @blur="isNumber">
                <span v-else>{{ scope.row.T3 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="T4" label="T4" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T4" @blur="isNumber">
                <span v-else>{{ scope.row.T4 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="T5" label="T5" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T5" @blur="isNumber">
                <span v-else>{{ scope.row.T5 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="T6" label="T6" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T6" @blur="isNumber">
                <span v-else>{{ scope.row.T6 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="T7" label="T7" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T7" @blur="isNumber">
                <span v-else>{{ scope.row.T7 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="T8" label="T8" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T8" @blur="isNumber">
                <span v-else>{{ scope.row.T8 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="T9" label="T9" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T9" @blur="isNumber">
                <span v-else>{{ scope.row.T9 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="T10" label="T10" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T10" @blur="isNumber">
                <span v-else>{{ scope.row.T10 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="T11" label="T11" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T11" @blur="isNumber">
                <span v-else>{{ scope.row.T11 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="T12" label="T12" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T12" @blur="isNumber">
                <span v-else>{{ scope.row.T12 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="T13" label="T13" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T13" @blur="isNumber">
                <span v-else>{{ scope.row.T13 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="T14" label="T14" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T14" @blur="isNumber">
                <span v-else>{{ scope.row.T14 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="T15" label="T15" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T15" @blur="isNumber">
                <span v-else>{{ scope.row.T15 }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="NitrogenFlow" label="氮气流量" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.NitrogenFlow" @blur="isNumber">
                <span v-else>{{ scope.row.NitrogenFlow }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="AdvanceTime" label="推进时间" align="center">
              <template slot-scope="scope">
                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.AdvanceTime" @blur="isNumber">

<template>
    <div class="ProcessParameterReport-Page" :class="{ blackBlueBg: $store.state.color === 'blackBlue' }">
        ...
        <div class="page-center">
            <div class="select">
                <div class="select-l">
                    ...
                    <el-date-picker class="hour-picker" :key="$store.state.color === 'blackBlue'
                        ? 'blackBlueBg hourPicker'
                        : 'normal hourPicker'
                        " :popper-class="$store.state.color === 'blackBlue'
        ? 'blackBlueBg hourPicker'
        : 'normal hourPicker'
        " type="datetime" v-model="seleTime" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
        ...
        ? 'blackBlueBg hourPicker'
        : 'normal hourPicker'
        " type="datetime" v-model="seleEndTime" placeholder="结束时间" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
            ...
            <div class="content">
                <div class="table-content" id="table-content">
                    <el-table ref="multipleTable" :data="tableData" :span-method="objectSpanMethod" :border="true"
                        style="width: 100%" height="100%" :header-cell-style="headFirst">
                        <el-table-column prop="Time" label="归档时间" width="150" :resizable="false" align="center">
                            <template slot-scope="scope">
                                <div v-if="scope.row.Time &&
                                    scope.row.Time.indexOf('记录人') >= 0
                                    " class="left white">
                                    {{ scope.row.Time }}
                                </div>
                        ...
                        <el-table-column prop="LineIndex" label="碳化线编号" width="100" :resizable="false" align="center">
                            <template slot-scope="scope">
                                <div v-if="scope.row.LineIndex &&
                                    scope.row.LineIndex.indexOf('确认人') >=
                                    0
                                    " class="left white">
                                    {{ scope.row.LineIndex }}
                                </div>
                        ...
                        <el-table-column prop="LineName" width="90" align="center">
                        </el-table-column>
                        <el-table-column prop="T1" label="T1" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T1"
                                    @blur="isNumber" />
                        ...
                        <el-table-column prop="T2" label="T2" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T2"
                                    @blur="isNumber" />
                        ...
                        <el-table-column prop="T3" label="T3" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T3"
                                    @blur="isNumber" />
                        ...
                        <el-table-column prop="T4" label="T4" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T4"
                                    @blur="isNumber" />
                        ...
                        <el-table-column prop="T5" label="T5" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T5"
                                    @blur="isNumber" />
                        ...
                        <el-table-column prop="T6" label="T6" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T6"
                                    @blur="isNumber" />
                        ...
                        <el-table-column prop="T7" label="T7" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T7"
                                    @blur="isNumber" />
                        ...
                        <el-table-column prop="T8" label="T8" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T8"
                                    @blur="isNumber" />
                        ...
                        <el-table-column prop="T9" label="T9" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T9"
                                    @blur="isNumber" />
                        ...
                        <el-table-column prop="T10" label="T10" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T10"
                                    @blur="isNumber" />
                        ...
                        <el-table-column prop="T11" label="T11" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T11"
                                    @blur="isNumber" />
                        ...
                        <el-table-column prop="T12" label="T12" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T12"
                                    @blur="isNumber" />
                        ...
                        <el-table-column prop="T13" label="T13" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T13"
                                    @blur="isNumber" />
                        ...
                        <el-table-column prop="T14" label="T14" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T14"
                                    @blur="isNumber" />
                        ...
                        <el-table-column prop="T15" label="T15" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.T15"
                                    @blur="isNumber" />
                                <span v-else>{{ scope.row.T15 }}</span>
                            </template>
                        </el-table-column>
                        <el-table-column prop="NitrogenFlow" label="氮气流量" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.NitrogenFlow"
                                    @blur="isNumber" />
                                <span v-else>{{ scope.row.NitrogenFlow }}</span>
                            </template>
                        </el-table-column>
                        <el-table-column prop="AdvanceTime" label="推进时间" align="center">
                            <template slot-scope="scope">
                                <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.AdvanceTime"
                                    @blur="isNumber" />
                                <span v-else>{{ scope.row.AdvanceTime }}</span>
                            </template>
                        </el-table-column>
                        <el-table-column prop="FurnacePressure" width="100" label="炉压（pa）" align="center">
                            <template slot-scope="scope">
...
export default {
    ...
    methods: {
        ...
        exportTable() {
            this.$axios({
                method: 'post',
                url: `/api/ProcessParameters/ExportProcessParamDataListByTime?startTime=${this.seleTime}&endTime=${this.seleEndTime}&isBSystem=${this.isBSystem}`,
                responseType: 'blob',
                timeout: 30000
            })
                .then(res => {
                    this.downloadFile(res.data, '工艺参数统计表.xlsx')
                })
            // this.$axios
            //     .get(

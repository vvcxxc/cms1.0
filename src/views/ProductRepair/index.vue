        ...
        <div class="linebox" id="linebox">
            <div class="query-table clearfix">
                <div class="fl">
                    ...
                    <span>产品型号</span>
                    <el-select style="margin-left:5px;width:170px" placeholder="请选择" v-model="ProductTypeCode">
                        <el-option label="全部" value="全部"></el-option>
                        <el-option v-for="item in ProductTypeList" :key="item.ProductTypeCode" :label="item.ProductTypeCode"
                            :value="item.ID">
                        </el-option>
                    </el-select>
                    <el-input style="margin-left:5px;width:200px" placeholder="请输入" v-model="inputFilter" />
            ...
            <div class="conter">
                <div class="conter-table">
                    <el-table highlight-current-row :cell-style="{ borderColor: '#E4E7ED' }"
                        ...
                        <el-table-column prop="ProductModel" label="产品型号" :show-overflow-tooltip="true"></el-table-column>
                        <el-table-column prop="ProductOrderNo" label="订单号" :show-overflow-tooltip="true"></el-table-column>
                        <el-table-column prop="RepairProcedure" label="返修工序"
                            :show-overflow-tooltip="true"></el-table-column>
                        <el-table-column prop="Remark" label="备注" :show-overflow-tooltip="true"></el-table-column>
                        <el-table-column prop="AddTime" label="新增时间" :show-overflow-tooltip="true"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getData(_index) {
            this.$axios({
                method: 'post',
                url: `/api/ProductRepair/QueryProductRepairs?st=${this.getDate(this.starttime)}&et=${this.getDate(this.endtime)}&PageSize=${this.pageData.PageSize}&PageIndex=${_index}&ProductModel=${this.ProductTypeCode}&KeyWord=${this.inputFilter}`,
            }).then(res => {
                if (res.data.code == 0) {

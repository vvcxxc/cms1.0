            ...
            <div class="select">
                <div class="select-l">
                    ...
                    <el-date-picker :key="$store.state.color === 'blackBlue' ? 'blackBlueBg' : 'normal'"
                        ...
                        v-model="selectTime" placeholder="查询时间" default-time="12:00:00"
...
export default {
    ...
    methods: {
        ...
        WorkshopRecordSentToPage() {
            ...
            this.$axios
                .post(
                    `/api/WorkshopRecord/WorkshopRecordSentToPage?KilnID=${this.curSelectItem}&time=${this.selectTime}&isSystemB=${isBSystem}`
                )
                .then(res => {
                    if (res.data.code == 0) {

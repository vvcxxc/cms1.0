    ...
    <div class="alarmBox qw">
        <div v-for="(item, index) in dataValue" :key="index">
            <div
                ...
                @contextmenu.prevent
                @mousedown="downClick(item.Class, $event, item)"
            ...
            >
                ...
                >
                    ...
                    >
                        <div
                            :class="item.Class + 'alarm_conter_rowBox'"
...
export default {
    ...
    methods: {
        ...
        //鼠标按下
        downClick(Class, e, item) {
            console.log(' downClick', item);
            var self = this;
            var EventScriptList = this.data.Data.EventScriptList;
            var EventType = [];
            var EventType1 = [];
        ...
        alarmRowFun(item, e) {
            ...
            if (name == 'alarm_conter_row') {
                ...
                $(e.path[0])
                    .parent(`.${item.Class}alarm_conter_row`)
                    .addClass('active1');
                $(e.path[0])
                    .parent(`.${item.Class}alarm_conter_row`)
        ...
        rightDownFun(item) {
            this.time1 = setInterval(() => {
                var dom = document.querySelector(
                    `.${item.Class}alarm_conter_rowBox`
                ).offsetWidth;
                var dom1 = document.querySelector(
                    `.${item.Class}alarm_conter`
                ).offsetWidth;
                var left = parseInt(
                    document.querySelector(`.${item.Class}alarm_conter_rowBox`)
                        .style.left
                );
                var num = dom1 - dom;
                if (left > num) {
                    document
                        .querySelector(`.${item.Class}alarm_conter_rowBox`)
                        .style.setProperty(
                            'left',
                            `${left - 1}px`,
                            'important'
                    ...
                    document
                        .querySelector(`.${item.Class}AlarmTitle`)
                        .style.setProperty(
                            'left',
                            `${left - 1}px`,
                            'important'
        ...
        datafun(resData, index, className, item) {
            ...
            var alarm_conter_rowBox = document.querySelector(
                `.${className}alarm_conter_rowBox`
            ).offsetWidth;
            var res = alarm_conter_rowBox > alarm_conter;
            if (res == true) {
                document.querySelector(
                    `.${className}alarm_fool_left`
                ).style.display = 'block';
                document.querySelector(
                    `.${className}alarm_fool_right`
                ).style.display = 'block';
            } else {
                document.querySelector(
                    `.${className}alarm_fool_left`

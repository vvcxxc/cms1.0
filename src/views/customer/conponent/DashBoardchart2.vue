...
export default {
    ...
    //鼠标松开
     ...
     opendb(item){
        ...
        dynamicNumber(){
            ...
            if(this.valueData != undefined && this.valueData.data != undefined){
            Ddata.title[0].subtext = Number(this.valueData.data)+Ddata.title[0].Unit
						Ddata.series[0].data[0].value = Number(this.valueData.data)<Number(Ddata.Range.Min)?0:Number(this.valueData.data)>Number(Ddata.Range.Max)?100:((Number(this.valueData.data)-Number(Ddata.Range.Min))/Number(Ddata.Range.Max))*100
						let color = ''
                      ...
                      if(this.valueData == undefined){
                       ...
                       if(this.valueData != undefined && this.valueData.data != undefined){
                        //    console.log(this.valueData.data)
                           Ddata.series[0].data[0].value = this.valueData.data
                           Ddata.series[0].detail.formatter = this.valueData.data+ this.Unit
                           var valueDataA
    ...
    drawLine1(){
		...
		if(this.optionData.ColorType1 !== "Multicolor"&&this.optionData.ColorType1 !== "GradientMulticolor"){
			...
			let obj = {
				value: Number(this.optionData.Variable.Value)<Number(this.optionData.Variable.Range1.Min)?0:Number(this.optionData.Variable.Value)>Number(this.optionData.Variable.Range1.Max)?100:((Number(this.optionData.Variable.Value)-Number(this.optionData.Variable.Range1.Min))/Number(this.optionData.Variable.Range1.Max))*100,
		      itemStyle: {
		        normal: {
		          color: new echarts.graphic.LinearGradient(1, 0, 0, 0,colorarr2)
		        }
			...
			this.dataarr.push(obj)
  			...
  			let option =  {
                ...
                opacity:this.optionData.Variable.Show?1:0,
					    ...
					    subtext: Number(this.optionData.Variable.Value)+ this.optionData.Variable.Unit,
						
					    subtextStyle: {
					     "fontSize":  this.optionData.Variable.Tooltip1.SeriesDetailFontSize,
					      show:this.optionData.Variable.Tooltip1.SeriesDetailShow,
						  color: !this.optionData.DetailColor1?this.optionData.DetailColor1:this.optionData.DetailColor1.HtmlColor,
					    },
					   left:'center',
					   top:this.optionData.Variable.Show?((Number(this.optionData.PositionOffset1)-6)+'%'):((Number(this.optionData.PositionOffset1)-12)+'%'),
        ...
        series: [
           {
            ...
            show:this.optionData.Variable.Range.ScaleShow,
              ...
              data: [{ value: this.Value, name:this.optionData.Variable.Show?this.DimensionName:'',itemStyle:{color:this.optionData.PointColor.HtmlColor} }],
                 title:{
                    offsetCenter: [0,"-30%"],
                    fontSize:this.optionData.Variable.FontSize  
                 }

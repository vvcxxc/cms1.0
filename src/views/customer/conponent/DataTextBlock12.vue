 ...
 * @Author: Tao
 * @LastEditors: Tao
 * @LastEditTime: 2021-04-07 15:01:49
 ***** TODO: 建议重构
 -->
<template>
<div class="DataTextBlockaa12">
  ...
  <div class="showWindow">
      <div style="position:fixed;left:0;right:0;bottom:0;top:0px;z-index:-1"></div>
      <div class="show_head">
...
export default {
    ...
    methods: {
      ...
      init(){
        ...
        var  textBox = document.querySelectorAll('.DataTextBlock121aa')

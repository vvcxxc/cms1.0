 ...
 * @Author: Tao
 * @LastEditors: Tao
 * @LastEditTime: 2021-04-07 14:25:28
 -->
<template>
  <div>
    <Keycom
    ...
    <div v-for="(item, index) in dataValue" :key="index">
      <div
        ...
        + item.fontFamily + '; fontSize:' + item.FontSize + 'px;'
        + 'boxSizing:border-box;' + 'overflow:hidden;white-space:nowrap;boxShadow:'
      ...
      >
        ...
        >
          <input
            ...
            + item.Foreground + ';fontWeight:' + item.Blod + ';text-decoration:' + item.TextDecorations + ';fontSize:' + item.FontSize + 'px'"
            type="text"
          />
        </div>
      </div>
            ...
            if (InputDataList[j].ElementName == this.textblockData[i].Name) {
              ...
              if (j == InputDataList.length - 1) {
                ...
                var value5 = {
                  ...
                  Foreground: foreColor,
                  Blod: this.textblockData[i].PropertyList.Blod == 'True' ? 'bold' : '',
                  TextDecorations: this.textblockData[i].PropertyList.TextDecorations == 'False' ? 'underline' : 'none',
                  ZIndex: this.ZIndex,
                  showLinear,
                  linearStyle
                }

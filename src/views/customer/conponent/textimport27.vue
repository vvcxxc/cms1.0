 ...
 * @Author: Tao
 * @LastEditors: Tao
 * @LastEditTime: 2021-02-05 18:02:59
 -->
<template>

    <div>
       <div v-for="(item,index) in dataValue" :key="index">
          <div v-if="show" :class="item.class" class="textimport27a" 
                 ...
                 if(this.data.Data.TextImportList[w].ElementName == this.textblockData[i].Name ){
                  ...
                  backColor = colorData.backColor
                   ...
                   var value = {
                        ...
                        value:this.data.Data.TextImportList[w].Text,
                        disabled:false,
                      ...
                      var value8 = {
                        ...
                        ZIndex:this.ZIndex
                          ...
                          this.dataValue.push(value8)
                           setTimeout(()=>{
                              let dom = document.querySelector(`.${this.textblockData[i].Name}`)
                              console.log('27==>',dom)
                              // dom.querySelector('input::-webkit-input-placeholder').style.color = '#e4393c'
                              let ddd = document.querySelector('input::-webkit-input-placeholder')
                              console.log('eee99',ddd)
                           },300)

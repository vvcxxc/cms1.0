 ...
 * @Author: Tao
 * @LastEditors: Tao
 * @LastEditTime: 2021-03-03 13:56:41
 -->
    ...
    <div class="alarmBox">
            ...
            >
                ...
                >
                    <div
                        ...
                        :style="
                            'margin-bottom:14px;position:relative;height:' +
                            item.HeaderFontSize +
                            'px;overflow:hidden'
                        "
                    >
                        <div
                            :class="'aa' + item.Class + 'AlarmTitle'"
                            style="position: absolute; left: 0px"
                        >
                            <div
                                :class="
                                    routerName + item.Class + 'alarm_title_no'
                                "
                                class="alarm_title_no left"
                                :style="
                                    'padding-right:17px;padding-left:6px;color:#000;font-size:' +
                                    item.HeaderFontSize +
                                    'px;line-height:' +
                                    item.HeaderFontSize +
                                    'px;color:' +
                                    item.headforeColor +
                                    ';background:' +
                                    item.headbackgroundColor +
                                    ';-webkit-background-clip:' +
                                    item.headclipText +
                                    ';fontWeight:' +
                                    item.HeaderBlod +
                                    ';text-decoration:' +
                                    item.HeaderTextDecorations +
                                    ';font-family:' +
                                    item.HeaderFontFamily
                                "
                            >
                                <!-- {{$t('AlarmMsg.langNo')}} -->{{
                            ...
                            <div
                                ...
                                "
                            >
                                <!-- {{$t('AlarmMsg.langAlarmInfo')}} -->{{
                                    lang.AlarmRecord_Time_DataGrid_Information
                                }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        :class="'aa' + item.Class + 'alarm_conter'"
                        class="alarm_conter"
                        :style="
                            ...
                            item.FontSize +
                            'px);' +
                            'overflow-x:hidden;position: relative;background:' +
                            item.Background
                        "
                    >
                        <div
                            :class="'aa' + item.Class + 'alarm_conter_rowBox'"
                            class="alarm_conter_rowBox"
                            style="
                                position: absolute;
                                top: 0;
                                left: 0;
                        ...
                        >
                            <div
                                ...
                                :style="
                                    ...
                                    item.FontSize +
                                    'px;padding-top:11px;padding-bottom:11px;display:inline-block;text-decoration:' +
                                    item.TextDecorations
                                "
                            >
                                <!-- {{$t('AlarmMsg.langNoAlarm')}} -->{{
                                    lang.AlarmRecord_NoAlarmInformation
                                }}
                            </div>

                            <!-- active21 默认不激活-->
                            <div
                                @click="alarmRowFun(item, $event)"
                                v-for="(it, inde) in item.resdata"
                                :key="inde"
                                :class="[
                                    'aa' + item.Class + 'alarm_conter_row',
                                    inde == 0 ? 'active21' : '',
                                ]"
                                class="alarm_conter_row"
                                name="alarm_conter_row"
                                :style="
                                    'background:' +
                                    item.itembackColor +
                                    ';border-bottom:1px solid;border-color:#090D2C;display:flex'
                                "
                            >
                                <!-- active21 默认不激活-->
                                <div
                                    class="alarm_conter_no"
                                    :class="[
                                        'aa' +
                                            routerName +
                                            item.Class +
                                    ...
                                    :style="
                                        'font-size:' +
                                        item.FontSize +
                                        'px;padding-left:18px;padding-right:18px;font-family:' +
                                        item.FontFamily +
                                        ';background:' +
                                        ...
                                        ';-webkit-background-clip:' +
                                        item.clipText +
                                        ';float:left; vertical-align: middle;fontWeight:' +
                                        item.Blod +
                                        ';line-height:' +
                                        item.FontSize +
                                        'px;padding-top:11px;padding-bottom:11px;border-right:1px solid #090D2C;margin-right:18px;display:inline-block;text-decoration:' +
                                        item.TextDecorations
                                    "
                                >
                                    {{ it.NO }}
                                ...
                                <!-- active21 默认不激活-->
                                <div
                                    class="alarm_conter_text"
                                    :class="inde == 0 ? 'active21' : ''"
                                    name="info"
                                    :style="
                                        'font-size:' +
                                        item.FontSize +
                    ...
                    <div
                        class="alarm_fool clearfix"
                        :class="'aa' + item.Class + 'alarm_fool'"
                        style="margin-top: 14px"
                    >
                        <div
                            @mousedown="leftDownFun(item)"
                            @mouseup="leftUpFun(item)"
                            :class="'aa' + item.Class + 'alarm_fool_left'"
                            class="alarm_fool_left left"
                        ></div>
                        <div
                            @mousedown="rightDownFun(item)"
                            @mouseup="rightUpFun(item)"
                            :class="'aa' + item.Class + 'alarm_fool_right'"
                            class="alarm_fool_right left"
                        ></div>
                        <div
                            v-if="
                                item.IsAlarmAmountVisibility.length == 0
                                    ? true
                                    : item.IsAlarmAmountVisibility
                            "
                            class="alarm_fool_num right"
                            :style="
                                'font-size:' +
                                item.FontSize +
                                'px;line-height:' +
                                item.FontSize +
                                'px;color:rgba(252, 210, 62, 1);text-decoration:' +
                                item.TextDecorations +
                                ';font-family:' +
                                item.FontFamily
                            "
                        ...
                        <div
                            ...
                            "
                        >
                            <!-- {{$t('AlarmMsg.langCurrentAlarmAmonut')}} -->{{
                                lang.AlarmRecord_CurrentNumberOfAlarms
                            }}
                        </div>
                    </div>
                </div>
        ...
        >
            <div v-if="commerPopShow1" class="commerPop_outPop">
                ...
                <div class="commerPop_conter">
                    {{ lang.NoOperationAuthority }}
                </div>
                <div class="commerPop_btn">
                    <div
                        class="commerPop_yes"
                        @click="Jurisdiction()"
                        style="width: 310px; margin-left: 25px"
                    >
    ...
    beforeDestroy() {
        if (this.$store.state.websocketsShow != null) {
            if (window.$.connection.redisMonitor) {
                ...
                window.$.connection.redisMonitor.server.UnRegistDeviceMessageRemind(
                    arr
                );
            }
        }
    ...
    methods: {
        ...
        seupClick(Class, e) {
            ...
            for (var i = 0; i < EventScriptList.length; i++) {
                if (
                    Class == EventScriptList[i].ElementName &&
        ...
        arrFun() {
            ...
            for (let i = 0; i < this.dataValue.length; i++) {
                for (let d = 0; d < A.length; d++) {
                    if (this.dataValue[i].Class == A[d].ElementName) {
                        ...
                        this.dataValue[i].IsAlarmAmountVisibility =
                            A[d].IsAlarmAmountVisibility;
                        this.dataValue[i].IsAlarmDataGridHeadersVisibility =
                            A[d].IsAlarmDataGridHeadersVisibility;
            ...
            for (let f = 0; f < this.dataValue.length; f++) {
                ...
                for (var j = 0; j < data.Data.AlarmTagItemList.length; j++) {
                    if (
                        data.Data.AlarmTagItemList[j].GroupID ==
                        this.dataValue[f].GroupID
                    ) {
                        this.dataValue[f].arr.push(
                            data.Data.AlarmTagItemList[j].TagName
                        );
                    }
                }
            }
            ...
            if (this.$store.state.websocketsShow != null) {
                ...
                if (this.msgHub2) {
                    for (let i = 0; i < this.dataValue.length; i++) {
                        ...
                        console.log(
                            'wweee',
                            window.$.connection.redisMonitor.server
                        );
                        window.$.connection.redisMonitor.server.RegistDeviceMessageRemind(
                            o
                        );
                    }
                }
        ...
        //点击选择事件
        alarmRowFun(item, e) {
            var rowdom = document.querySelectorAll(
                `.aa${item.Class}alarm_conter_row`
            );
            for (let j = 0; j < rowdom.length; j++) {
                rowdom[j].classList.remove('active1');
                rowdom[j]
                    .querySelector(`.alarm_conter_text`)
                    .classList.remove('active2');
                rowdom[j]
                    .querySelector(`.alarm_conter_no`)
                    .classList.remove('active2');
            }
            ...
            if (name == 'alarm_conter_row') {
                ...
                $(e.path[0])
                    .parent(`.aa${item.Class}alarm_conter_row`)
                    .addClass('active1');
                $(e.path[0])
                    .parent(`.aa${item.Class}alarm_conter_row`)
        ...
        rightDownFun(item) {
            this.time1 = setInterval(() => {
                var dom = document.querySelector(
                    `.aa${item.Class}alarm_conter_rowBox`
                ).offsetWidth;
                var dom1 = document.querySelector(
                    `.aa${item.Class}alarm_conter`
                ).offsetWidth;
                var left = parseInt(
                ...
                if (left > num) {
                    document
                        .querySelector(`.aa${item.Class}alarm_conter_rowBox`)
                        .style.setProperty(
                            'left',
                            `${left - 1}px`,
                            'important'
                    ...
                    document
                        .querySelector(`.aa${item.Class}AlarmTitle`)
                        .style.setProperty(
                            'left',
                            `${left - 1}px`,
                            'important'
        ...
        datafun(resData, index, className, item) {
            ...
            //横向箭头是否出现
            var alarm_conter = document.querySelector(
                `.aa${className}alarm_conter`
            ).offsetWidth;
            var alarm_conter_rowBox = document.querySelector(
                `.aa${className}alarm_conter_rowBox`
            ).offsetWidth;
            var res = alarm_conter_rowBox > alarm_conter;
            if (res == true) {
                document.querySelector(
                    `.aa${className}alarm_fool_left`
                ).style.display = 'block';
                document.querySelector(
                    `.aa${className}alarm_fool_right`
                ).style.display = 'block';
            } else {
                document.querySelector(
                    `.aa${className}alarm_fool_left`
            ...
            var noDom = document.querySelectorAll(
                `.aa${this.routerName}${className}alarm_conter_no`
            );
            var noDomLength = 0;
            ...
            var titleDom = document.querySelector(
                `.aa${this.routerName}${className}alarm_title_no`
            );
            ...
            var headH = document.querySelector(
                `.aa${className}AlarmTitle`
            ).offsetHeight;
            var flooH = document.querySelector(
                `.aa${className}alarm_fool`
            ).offsetHeight;
            document.querySelector(
                `.${className}alarm_conter`
            ).style.height = `calc(100% - 28px - ${headH}px - ${flooH}px)`;
            // if(item.IsAlarmAmountVisibility==false && res==false){
            //     document.querySelector(`.aa${className}alarm_conter`).style.height = `calc(100% - ${headH}px - 14px)`
            // }else{
            //     document.querySelector(`.aa${className}alarm_conter`).style.height = `calc(100% - 28px - ${headH}px - ${flooH}px)`
            // }
            // if(item.IsAlarmDataGridHeadersVisibility == false && res==false && item.IsAlarmAmountVisibility == false){
            //     document.querySelector(`.aa${className}alarm_conter`).style.height = `calc(100%)`
            // }else if(item.IsAlarmDataGridHeadersVisibility == false && res==true && item.IsAlarmAmountVisibility == false){
            //     document.querySelector(`.aa${className}alarm_conter`).style.height = `calc(100% - 28px)`
        ...
        colorFun(
            ...
            if (HeaderForeground.ColorType == 'SolidColor') {
                headforeColor =
                    '#' +
                    HeaderForeground.Data.Color.slice(3) +
                    HeaderForeground.Data.Color.slice(1, 3);
                headclipText = 'none';
                ...
                for (
                    let g2 = 0;
                    g2 < HeaderForeground.Data.GradientStops.length;
                    g2++
                ) {
            ...
            if (ItemBackground.ColorType == 'SolidColor') {
                itembackColor =
                    '#' +
                    ItemBackground.Data.Color.slice(3) +
                    ItemBackground.Data.Color.slice(1, 3);
            } else {
                itembackColor = '';
                lagel2 = ItemBackground.Data.Angel.toFixed(0);
                for (
                    let h2 = 0;
                    h2 < ItemBackground.Data.GradientStops.length;
                    h2++
                ) {
        ...
        gitValue() {
            ...
            for (var i = 0; i < this.textblockData.length; i++) {
                ...
                var borderbrushArr = JSON.parse(
                    this.textblockData[i].PropertyList.WraperBorderBrush
                );
                var backgroundArr = JSON.parse(
                    this.textblockData[i].PropertyList.WraperBackground
                );
                var HeaderForeground = JSON.parse(
                    this.textblockData[i].PropertyList.HeaderForeground
                );
                var ItemBackground = JSON.parse(
                    this.textblockData[i].PropertyList.ItemBackground
                );
                //渐变色
                ...
                var radius =
                    this.textblockData[i].PropertyList.OutWraperCornerRadius;
                var value = {
                    ...
                    HeaderBlod:
                        this.textblockData[i].PropertyList.HeaderBlod == 'True'
                            ? 'bold'
                            : '',
                    WraperBorderThickness:
                        this.textblockData[i].PropertyList
                            .WraperBorderThickness,
                    TextDecorations:
                        this.textblockData[i].PropertyList.TextDecorations ==
                        'False'
                            ? 'none'
                            : 'underline',
                    HeaderTextDecorations:
                        this.textblockData[i].PropertyList
                            .HeaderTextDecorations == 'False'
                            ? 'none'
                            : 'underline',
                    ...
                    HeaderFontFamily:
                        this.textblockData[i].PropertyList.HeaderFontFamily,
                    HeaderFontSize:
                        this.textblockData[i].PropertyList.HeaderFontSize,
                    FontSize: this.textblockData[i].PropertyList.FontSize,
                    FontFamily: this.textblockData[i].PropertyList.FontFamily,
                    Blod:
                        this.textblockData[i].PropertyList.Blod == 'True'
                            ? 'bold'
                            : '',

 ...
 * @Author: Tao
 * @LastEditors: Tao
 * @LastEditTime: 2021-03-18 09:24:42
 -->
<template>
<div class="CommonLampa_box">
  ...
  <div
    ...
    name="commonlamp" :ref="item.class" :class="'aa'+item.class" class="CommonLampa16" 
    :style="'position:absolute;' + 'left:' + item.left + 'px; top:' + item.top + 'px;' 
    + '; text-align:center; line-height:'+ item.height + 'px; width:'+ item.width 
    + 'px; height:'+ item.height + 'px; borderRadius:' + item.radiusLeft + 'px ' 
    + item.radiusTop + 'px ' + item.radiusRight + 'px ' + item.radiusButton + 'px; opacity:' 
         ...
         this.Name = 'commonlamp'
          ...
          for(var k=0;k<this.data.Data.StatusAnimationList.length;k++){
            ...
            if(index != -1 && nameNull != null){
              ...
              // this.resTagName.push(this.data.Data.StatusAnimationList[k].TagName)
              var value = {

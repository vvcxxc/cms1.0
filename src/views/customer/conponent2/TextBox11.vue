        ...
        <div v-for="(item, index) in dataValue" :key="index">
            ...
            >
                ...
                >
                    <input
                        autocomplete="off"
                        @keyup.enter="keupFun(item)"
                        name="datatextbox"
                        :class="'aa' + item.class"
                        v-model="item.text"
                        :style="
                            'height:' +
                                (item.height - item.BorderThickness * 2) +
                                'px;border:none;width:' +
                                (item.width - item.BorderThickness * 2) +
                                'px;background:transparent;textAlign:center;color:' +
                                item.Foreground +
                                ';fontWeight:' +
                                item.Blod +
                                ';text-decoration:' +
    ...
    methods: {
                ...
                this.jurisdictionShow(item).then(val => {
                    if (this.CanExcuteShow) {
                        ...
                        if (variableName == this.lang['二进制变量']) {
                            ...
                            variableName == this.lang['有符号16位整型']
                        ) {
                            this.judgeFun(
                                item.text,
                                32767,
                            ...
                            variableName == this.lang['无符号16位整型']
                        ) {
                            this.judgeFun(
                                item.text,
                                65535,
                            ...
                            variableName == this.lang['有符号32位整型']
                        ) {
                            this.judgeFun(
                                item.text,
                                2147483647,
                            ...
                            variableName == this.lang['无符号32位整型']
                        ) {
                            this.judgeFun(
                                item.text,
                                4294967295,
                            ...
                            variableName == this.lang['有符号64位整型']
                        ) {
                            this.judgeFun(
                                item.text,
                                9223372036854775807,
                            ...
                            variableName == this.lang['无符号64位整型']
                        ) {
                            this.judgeFun(
                                item.text,
                            ...
                            variableName == this.lang['F32位浮点数IEEE754']
                        ) {
                            this.judgeFun(
                                item.text,
                                3.40282347e38,
                            ...
                            variableName == this.lang['F64位浮点数IEEE754']
                        ) {
                            this.judgeFun(
                                item.text,
                            ...
                            var time = moment('2020-02-02 ' + item.text).format(
                                'LTS'
                            );
      ...
      let Min = ''
        ...
        DateFun(text, TagType, item) {
            ...
            Indexarr.push(index5);
            Indexarr.push(index4);
            Indexarr.push(index3);
            ...
            for (var i = 0; i < this.textblockData.length; i++) {
                ...
                if (InputDataList.length != 0) {
                        ...
                        if (
                            ...
                            if (borderSadow.InnerShadow != undefined) {
                                InnerShadow =
                                    ...
                                    'px ' +
                                    borderSadow.InnerShadow.BlurRadius.toFixed(
                                        0
                                    ) +
                                    'px ' +
                            ...
                            if (borderSadow.OuterShadow != undefined) {
                                OuterShadow =
                                    ...
                                    'px ' +
                                    borderSadow.OuterShadow.BlurRadius.toFixed(
                                        0
                                    ) +
                                    'px ' +
                            ...
                            if (borderbrushArr.ColorType == 'SolidColor') {
                                ...
                                for (
                                    var f1 = 0;
                                    f1 <
                                    borderbrushArr.Data.GradientStops.length;
                                    f1++
                                ) {
                                    gradient1 =
                            ...
                            if (backgroundArr.ColorType == 'SolidColor') {
                                ...
                                for (
                                    var h1 = 0;
                                    h1 <
                                    backgroundArr.Data.GradientStops.length;
                                    h1++
                                ) {
                                    gradient =
                                        backgroundArr.Data.GradientStops[h1];
                                    backColor =
                                        backColor +
                                        ',' +
                                        gradient.Color +
                            ...
                            if (foregoundArr.ColorType == 'SolidColor') {
                                ...
                                for (
                                    var g = 0;
                                    g < foregoundArr.Data.GradientStops.length;
                                    g++
                                ) {
                                    gradient2 =
                                        foregoundArr.Data.GradientStops[g];
                                    backgroundColor =
                                        backgroundColor +
                                        ',' +
                                        gradient2.Color +
                            ...
                            var value = {
                                ...
                                opacity:
                                    ...
                                    100,
                                FontSize: this.textblockData[i].PropertyList
                                    .FontSize,
                                ...
                                text: '',
                                BorderThickness: this.textblockData[i]
                                    .PropertyList.BorderThickness,
                                Shadow: Shadow,
                                inputWidth: '2',
                                Foreground: foreColor,
                                Blod:
                                    this.textblockData[i].PropertyList.Blod ==
                                    'True'
                                        ? 'bold'
                                        : '',
                                TextDecorations:
                            ...
                            if (j == InputDataList.length - 1) {
                                ...
                                if (backgroundArr.ColorType == 'SolidColor') {
                                    ...
                                    for (
                                        ...
                                        gradient =
                                            backgroundArr.Data.GradientStops[
                                                h2
                                            ];
                                        backColor =
                                            backColor +
                                ...
                                if (foregoundArr.ColorType == 'SolidColor') {
                                    ...
                                    for (
                                        var g1 = 0;
                                        g1 <
                                        foregoundArr.Data.GradientStops.length;
                                        g1++
                                    ) {
                                        gradient2 =
                                            foregoundArr.Data.GradientStops[g1];
                                        backgroundColor =
                                            backgroundColor +
                                            ',' +
                                            gradient2.Color +
                                            ' ' +
                                            (gradient2.Offset * 100).toFixed(
                                                0
                                            ) +
                                            '%';
                                    }
                    ...
                    if (borderbrushArr.ColorType == 'SolidColor') {
                        ...
                        for (
                            var f3 = 0;
                            f3 < borderbrushArr.Data.GradientStops.length;
                            f3++
                        ) {
                    ...
                    if (backgroundArr.ColorType == 'SolidColor') {
                        ...
                        for (
                            var h3 = 0;
                            h3 < backgroundArr.Data.GradientStops.length;
                            h3++
                        ) {
                    ...
                    var value9 = {
                        ...
                        TagDataType: '',
                        text: '数值输入',
                        BorderThickness: this.textblockData[i].PropertyList
                            .BorderThickness,
                        Shadow: Shadow,
                        inputWidth: '55',
                        Foreground: foreColor,

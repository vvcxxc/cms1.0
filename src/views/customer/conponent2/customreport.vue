...
<template>
    <div v-if="show">
        <div
            ...
            :key="key"
            :id="item.Name"
            :style="'position:absolute;' + 'left:' + item.PropertyList.Left + 'px; top:' + item.PropertyList.Top  + 'px; width:'+ item.PropertyList.Width + 'px; height:'+ item.PropertyList.Height + 'px;'+'RotateAngle:'+item.PropertyList.RotateAngle+'Opacity:'+item.PropertyList.Opacity + ';zIndex:'+item.PropertyList.ZIndex"
        >
...
export default {
    ...
    methods: {
     insert(arrfirst,arrlast,index){    //将数组arrlast插入数组arrfirst中，index是想要插入的位置
    if (index < 0){
        index = 0;
                ...
                var end = this.cavantable[i].ParameterReportItemtList.dd;
                  if(('#'+this.cavantable[i].Name+'page')[0]){
                    if(end.kzdirection == '横向扩展'){
                        ...
                        var left = 0;
                        var top = 0;
                        var startx = $($("#"+this.cavantable[i].Name).find('.datareadyhead')[0]).attr('id').split('-')[1]
                        var starty =  $($("#"+this.cavantable[i].Name).find('.datareadyhead')[0]).attr('id').split('-')[0]
                        if(end.kzsummopos=='分布在后'&&$("#"+this.cavantable[i].Name).find('.datareadyfoot').length>0){
                            endy = $($("#"+this.cavantable[i].Name).find('.datareadyhead')[$("#"+this.cavantable[i].Name).find('.datareadyhead').length-1]).attr('id').split('-')[1]
                            endx = $($("#"+this.cavantable[i].Name).find('.datareadyfoot')[$("#"+this.cavantable[i].Name).find('.datareadyfoot').length-1]).attr('id').split('-')[0]
                        }else{
                            endy = $($("#"+this.cavantable[i].Name).find('.datareadyhead')[$("#"+this.cavantable[i].Name).find('.datareadyhead').length-1]).attr('id').split('-')[1]
                            endx = $($("#"+this.cavantable[i].Name).find('.dataready')[$("#"+this.cavantable[i].Name).find('.dataready').length-1]).attr('id').split('-')[0]
                        }
                         for(let i1 = 0;i1<=endx;i1++){
                            left = left+parseFloat($($("#"+this.cavantable[i].Name).find('#'+i1+"-"+startx)[0]).width())
                              if($($("#"+this.cavantable[i].Name).find('#'+i1+"-"+startx)[0]).hasClass("borderleft")){
                                left+=1
                            }
                        }
                         for(let i1 = 0;i1<=endy;i1++){
                            top = top+parseFloat($($("#"+this.cavantable[i].Name).find('#'+starty+"-"+i)[0]).height())
                            if($($("#"+this.cavantable[i].Name).find('#'+starty+"-"+i)[0]).hasClass("bordertop")){
                                top+=1
                            }
                        }
                        left = parseInt($("#"+this.cavantable[i].Name)[0].style.left) + left
                         top = parseInt($("#"+this.cavantable[i].Name)[0].style.top) + top+1
                         if(left<=0){
                             $('#'+this.cavantable[i].Name+'page')[0].style.left = 0 + 'px'
                         }else{
                             $('#'+this.cavantable[i].Name+'page')[0].style.left = left + 'px'
                         }
                         
                             $('#'+this.cavantable[i].Name+'page')[0].style.top = top + 'px'
                    }else if(end.kzdirection == '纵向扩展'){
                         endy  = 0;
                         endx  = 0;
                         left = 0;
                         top = 0;
                         startx = $($("#"+this.cavantable[i].Name).find('.datareadyhead')[0]).attr('id').split('-')[1]
                         starty =  $($("#"+this.cavantable[i].Name).find('.datareadyhead')[0]).attr('id').split('-')[0]
                        //   alert("s")
 
                        if(end.kzsummopos=='分布在后'&&$("#"+this.cavantable[i].Name).find('.datareadyfoot').length>0){
                           
                            endy = $($("#"+this.cavantable[i].Name).find('.datareadyfoot')[$("#"+this.cavantable[i].Name).find('.datareadyfoot').length-1]).attr('id').split('-')[1]
                            endx = $($("#"+this.cavantable[i].Name).find('.datareadyfoot')[$("#"+this.cavantable[i].Name).find('.datareadyfoot').length-1]).attr('id').split('-')[0]
                        }else{
                            endy = $($("#"+this.cavantable[i].Name).find('.dataready')[$("#"+this.cavantable[i].Name).find('.dataready').length-1]).attr('id').split('-')[1]
                            endx = $($("#"+this.cavantable[i].Name).find('.dataready')[$("#"+this.cavantable[i].Name).find('.dataready').length-1]).attr('id').split('-')[0]
                        }
                        for(let i1 = 0;i1<=endx;i1++){
                            left = left+parseFloat($($("#"+this.cavantable[i].Name).find('#'+i1+"-"+startx)[0]).width())
                        ...
                        left = parseInt($("#"+this.cavantable[i].Name)[0].style.left) + left - 190
                         top = parseInt($("#"+this.cavantable[i].Name)[0].style.top) + top+1
                           if(left<=0){
                            $('#'+this.cavantable[i].Name+'page')[0].style.left = 0 + 'px'
                        }else{
...
//   }       
  for (let dc1 = 0; dc1 < this.cavantable.length; dc1++) {
      console.log(JSON.parse(JSON.stringify(this.cavantable)))
            ...
            for (let dc = 0; dc < this.cavantable.length; dc++) {
                ...
                if (
                    ...
                    this.$store.state.isShow = true;
                      ...
                      await this.delay(100) 
                        $('.btablecover').show()
                      let word = this.lang.ReportForm_Exporting.replace('{0}',(dc+1))
                       $('.btableconterword')[0].innerHTML = word
                    // setTimeout(() => {
                        if (this.cavantable[dc].data.length > 65000) {
                            this.tipchange = true;
                            this.tipword = /* this.lang.ReportForm_ExportDataUpTo10000 */ '导出数据最多6.5W条';
                            this.pdyd3 = true;
                                  this.$store.state.isShow = false;
                                   $('.btablecover').hide()
                            return;
                    ...
                    //         }
                            if( $(
                                 ...
                                 for(let cc =0;cc<$(b).find('.dataready').length;cc++){
                            $($(b).find('.dataready')[cc]).find("input")[0].setAttribute('value','')
                         $($(b).find('.dataready')[cc]).find("input")[0].value = ''
                        }
                            ...
                            let length = $(a).find('.daochu').length;
                              for (let i1 = 0; i1 < $(a).find('td').length; i1++) {
                                    if($(a).find('td')[i1].style.display=='none'&&(parseInt($($(a).find('td')[i1]).attr('id').split('-')[0])<(this.cavantable[dc].ParameterReportItemtList.dd.startpox))){
                      ...
                      this.$emit('percentage1',(parseInt(10/(length-i1))))
                           ...
                           await this.delay(i1)
                            ...
                            let endlength;
                            var xzdata = Math.ceil(this.cavantable[dc].data.length/this.cavantable[dc].ParameterReportItemtList.dd.kzresourcedataitemarray.length)+Number(this.cavantable[dc].ParameterReportItemtList.dd.startpoy)
                            if (daiti.kzsummopos !== '分布在前') {
                                endlength = parseInt(length)+
                                    parseInt(
                                        this.cavantable[dc]
                                            .ParameterReportItemtList.dd
                                            .startpoy
                                ...
                                endlength = parseInt(length) + sumdata1.length+ parseInt(
                                        this.cavantable[dc]
                                            .ParameterReportItemtList.dd
                                            .startpoy
                                    );
							...
							// } 
                                ...
                                if(this.cavantable[dc].numpage > 1&&$('#'+this.cavantable[dc].Name+'page')[0]) {
                                      for(let ii = parseInt(endlength); ii < parseInt(endlength)+parseInt($($("#"+this.cavantable[dc].Name).find('td')[$("#"+this.cavantable[dc].Name).find('td').length-1]).attr('id').split('-')[1])-parseInt($($("#"+this.cavantable[dc].Name).find('.dataready')[$("#"+this.cavantable[dc].Name).find('.dataready').length-1]).attr('id').split('-')[1]); ii++){
                   let changeil = []
                   for(let cc11 = 0; cc11 <  $($(b).find('#row-'+ii)[0]).find('td').length; cc11++){
                                          if(!$($($(b).find('#row-'+ii)[0]).find('td')[cc11]).hasClass('dataready')&&!$($($(b).find('#row-'+ii)[0]).find('td')[cc11]).hasClass('datareadyfoot')){
                                              if(ii<=this.cavantable[dc].endpoy+this.cavantable[dc].ParameterReportItemtList.dd.kzsummotype.split(',').length){
                                        if($( $('#' + this.cavantable[dc].Name).find('#row-'+ii)[0]).find('td')[cc11]){
                                               if($($( $('#' + this.cavantable[dc].Name).find('#row-'+ii)[0]).find('td')[cc11]).attr('style')||$( $('#' + this.cavantable[dc].Name).find('#row-'+ii)[0]).find('td')[cc11].innerHTML||$($( $('#' + this.cavantable[dc].Name).find('#row-'+ii)[0]).find('td')[cc11]).hasClass('bordertop')||$($( $('#' + this.cavantable[dc].Name).find('#row-'+ii)[0]).find('td')[cc11]).hasClass('borderleft')){
                                            changeil.push({
																			index:cc11,
                                                                            text:$( $('#' + this.cavantable[dc].Name).find('#row-'+ii)[0]).find('td')[cc11].innerHTML,
																			style:$($( $('#' + this.cavantable[dc].Name).find('#row-'+ii)[0]).find('td')[cc11]).attr('style'),
																			classname:$($( $('#' + this.cavantable[dc].Name).find('#row-'+ii)[0]).find('td')[cc11]).attr('class')
																		})
																	}
                                        }
                   ...
                   this.$emit('percentage1',(parseInt((70/(this.cavantable[dc].numpage-cc1))+10)))
                            ...
                            let now = parseInt(this.cavantable[dc].ParameterReportItemtList.dd.startpoy)+1;
                            ...
                            if(daiti.kzsummopos == '分布在前'){
                              ...
                              if (daiti.kzsummopos == '分布在后') {
                                length5 = length * this.cavantable[dc].numpage + now;
                            }
                             let removeid = parseInt(endlength)+parseInt($($("#"+this.cavantable[dc].Name).find('td')[$("#"+this.cavantable[dc].Name).find('td').length-1]).attr('id').split('-')[1])-parseInt($($("#"+this.cavantable[dc].Name).find('.dataready')[$("#"+this.cavantable[dc].Name).find('.dataready').length-1]).attr('id').split('-')[1])
                             let nowcii = 0
                            if (this.cavantable[dc].numpage > 1&&$('#'+this.cavantable[dc].Name+'page')[0]) {
             ...
             for(let cc11 = 0; cc11 <  $($(b).find('tr')[ii]).find('td').length; cc11++){
                                          if(!$($($(b).find('tr')[ii]).find('td')[cc11]).hasClass('dataready')&&!$($($(b).find('tr')[ii]).find('td')[cc11]).hasClass('datareadyfoot')){
                            ...
                            //    for(let cc12 = 0; cc12 < changeii.length; cc12++){
                                for(let cc11 = 0; cc11 < changeii[nowcii].length; cc11++){
                                    if(changeii[nowcii][cc11].index>parseInt(this.cavantable[dc].endpox)||changeii[nowcii][cc11].index<parseInt(this.cavantable[dc].startpox)){
                            ...
                            //         }
                                    ...
                                    for (let i2 = 0; i2 < length1; i2++) {
                                        ...
                                        if (
                                            ...
                                            for (
                                             ...
                                             for (
                                                ...
                                                if (shi6[i1].id == (parseInt($($($(b).find('tr')[ii]).find('input')[i2]).parent().attr('id').split('-')[0])-  parseInt(
                                            this.cavantable[dc]
                                                .ParameterReportItemtList.dd
                                                .startpox
                                        ))) {
                                            ...
                                            $($(b).find('tr')[ii])
                                                .find('input')[i2].setAttribute('value', aaa);
                                                        ...
                                                        if($($(b).find('tr')[ii]).find('input')[i2].value){
                                       ...
                                       if(itemformat){
                                          let aaa1 = this.dateFormat(itemformat,$($(b).find('tr')[ii]).find('input')[i2].value)
                                        $($(b).find('tr')[ii]).find('input')[i2].setAttribute('value', aaa1);
                                            $(
                                                            $(b).find('tr')[ii]
                                                        ).find('input')[
                                                            i2
                                        ...
                                        nowi2++;
                                           this.$emit('percentage1',((parseInt(20*((ii*length1+i2)/(length5*length1)))+80)))
                    ...
                    this.$emit('percentage1',100)
                        ...
                        for(let cc =0;cc<$(b).find('.heibin').length;cc++){
                          ...
                          for(let c1=0;c1<$(b).find('col').length;c1++){
                              ...
                              let a ={
                                  wpx:parseFloat($($(b).find('col')[c1]).attr('width'))
                              }
                              width.push(a)
                          }
                            let height = []
                          for(let c1=0;c1<$(b).find('tr').length;c1++){
                              ...
                              let a ={
                                  hpx:parseFloat($($(b).find('tr')[c1]).height())
                              }
                              height.push(a)
                          }
   ...
   this.$store.state.isShow = false;
     $('.btablecover').hide()
   console.log("data3",Date.parse(new Date()),new Date())
                            ...
                            let adiv = this.cavantable[dc].daochutable;
                            xzdata = Math.floor((this.cavantable[dc].data.length/this.cavantable[dc].ParameterReportItemtList.dd.kzresourcedataitemarray.length)-parseFloat(this.cavantable[dc].ParameterReportItemtList.dd.kzresourcedataitemarray.startx))
                            let a = $(
                                this.cavantable[dc].daochutable
                            )[0].cloneNode(true);
                            console.log("clone", $(
                    ...
                    .find('table')[0])
                            ...
                            for(let a1=0;a1<$(b).find('.heibin').length;a1++){
                                if(parseFloat($(b).find('.heibin')[a1].id.split('-')[1])<parseFloat(this.cavantable[dc].ParameterReportItemtList.dd.startpoy)&&parseFloat($(b).find('.heibin')[a1].id.split('-')[0])>parseFloat(this.cavantable[dc].ParameterReportItemtList.dd.startpoy)){
                       if(parseFloat($(b).find('.heibin')[a1].id.split('-')[1])+parseFloat($($('.heibin')[a1]).attr('rowspan'))>parseFloat(this.cavantable[dc].ParameterReportItemtList.dd.startpoy)){
                                           let c = parseFloat(this.cavantable[dc].ParameterReportItemtList.dd.startpoy);
                                           $($(b).find('.heibin')[a1]).attr('rowspan',c)
                                           for(let a2=0;a2<$($(b).find('.heibin')[a1]).attr('name').split(',').length;a2++){
                                               let c1 = $($(b).find('.heibin')[a1]).attr('name').split(',')[a2]
                                               if(c1){
                                    if(this.cavantable[dc].shi5.includes($('#'+c1)[0].id.split('-')[1])){
                                               ($($(b).find('.heibin')[a1]).find('#'+c1)).show()
                                             }
                                               }
                            ...
                            console.log(this.cavantable[dc])
                                            for(let cc =0;cc<$(a).find('td').length;cc++){
                                                if(!$($($(a).find('td')[cc])[0]).hasClass('datareadyhead')&&!$($($(a).find('td')[cc])[0]).hasClass('dataready')&&!$($($(a).find('td')[cc])[0]).hasClass('datareadyfoot')){
     if($($(a).find('td')[cc])[0].style.display == 'none'||$($(a).find('td')[cc]).attr('showtd')){
                                  $($(a).find('td')[cc]).remove()
                                  cc--
                                                }
                                   ...
                                   if($($(a).find('td')[cc]).hasClass('item')){
                                       if(!$(a).find('td')[cc].style.backgroundColor){
                                          $($(a).find('td')[cc]).css('background','#F9DEE0')
                                       }
                               if(!$(a).find('td')[cc].style.color){
                                         $($(a).find('td')[cc]).css('color','#EF3460')
                                       }
                           ...
                           if($($(a).find('td')[cc]).attr('rowspan')==1){
                            $($(a).find('td')[cc]).removeAttr("rowspan")
                                     ...
                                     for(let cc =0;cc<$(b).find('td').length;cc++){
                                               if(!$($($(b).find('td')[cc])[0]).hasClass('datareadyhead')&&!$($($(b).find('td')[cc])[0]).hasClass('dataready')&&!$($($(b).find('td')[cc])[0]).hasClass('datareadyfoot')){
             ...
             this.$emit('percentage1',(parseInt(70/(this.cavantable[dc].numpage - 1 -num))))
                                    ...
                                    for (row = 0; row < length; row++) {
                                        ...
                                        if (
                                            ...
                                            for (
                                                ...
                                                if (shi5[i1].id == (row+parseInt(this.cavantable[dc].ParameterReportItemtList.dd.startpoy))) {
                                                //     console.log(   $(
                                                //     $(b).find('.daochu')[row]
                                                // ).find('input')[
                                                //     col
                                            ...
                                            console.log(shi6)
                                             for (
                                                ...
                                                if (shi6[i1].id == (row+parseInt(this.cavantable[dc].ParameterReportItemtList.dd.startpoy))) {
                                                    itemformat = shi6[i1].itemformat;
                                                    break;
                                                } 
                                            }
                                            ...
                                            if (xnumber !== '') {
                                                ...
                                                if (
                                                    ...
                                                    console.log("asddassaddsaasddsa",xnumber)
                                                    console.log(shi5)
  ...
  $(
                                        ...
                                        if($(
                                            ...
                                            if(itemformat){
                                               let aaa1 = this.dateFormat(itemformat,$(
                                                    $(b).find('.daochu')[row]
                                                ).find('input')[
                                                    col
                                                ].value)
 ...
 $(
                                        ...
                                        length    
                                        nowi2++;
                                          this.$emit('percentage1',((parseInt(30*((col*length+row)/($($(b).find('.daochu')[0]).find( '.dataready').length*length)))+70)))
                                        ...
                                        if (sumdata1[i1] == 'sum') {
                                            for (
                                                ...
                                                if (
                                                    ...
                                                    if (shi5[ii2].id == ((i+parseInt(this.cavantable[dc].ParameterReportItemtList.dd.startpoy)))) {
                                                        sumdao = this.getPointNum(
                                                            sumdao,
                                                            shi5[ii2].xsnumber
                                                        );
  ...
  $(
                                        ...
                                        if (sumdata1[i1] == 'mean') {
                                            for (
                                                ...
                                                if (
                                                    ...
                                                    if(isNaN(meandata)||meandata == undefined){
                                                        meandata = 0;
                                                    }
                                                if(Number(  $(
                                                        $(b).find('.daochu')[i]
                                                ...
                                                if (
                                                    ...
                                                    $(
                                                     ...
                                                     if(Number(  $(
                                                        ...
                                                        if (
                                                            max[max.length - 1] ==
                                                            'undefined'||  max[max.length - 1] ==undefined||isNaN(max[max.length - 1])
                                                        ) {
                                                            $(
                                                                $(b).find(
                                                                    '.daochu'
                                                ...
                                                for (
                                                 ...
                                                 if(Number(  $(
                                                        ...
                                                        if (
                                                            ...
                                                            if (max[0] == 'undefined'||max[0] ==undefined||isNaN(max[0])) {
                                                                $(
                                                                    $(b).find(
                                                                        '.daochu'
                                                                    )[i]
            ...
            //         }   
              let width1 = []        
                            for(let a = parseFloat(this.cavantable[dc].ParameterReportItemtList.dd.startpox);a<=this.cavantable[dc].endpox;a++){
                           
                              let a1 ={
                                  wpx:parseFloat($($(b).find('col')[a]).attr('width'))
                              }
                               width1.push(a1)
                            }
                         let width = []
                        ...
                        //   console.log( this.cavantable[dc])
                          for(let ai=0;ai<this.cavantable[dc].numpage;ai++){
                             width = this.insert(width,width1,parseFloat(this.cavantable[dc].ParameterReportItemtList.dd.startpox))
                          }
            ...
            for (let ic = 0; ic < this.cavantable.length;ic++) {
                ...
                // this.$store.state.isShow  = true
                        let searchdata = []
                          ...
                          if(this.cavantable[ic].ParameterReportItemtList.dd.startkongjian){
                            searchdata.push(this.cavantable[ic].ParameterReportItemtList.dd.startkongjian)
                        }
                          if(this.cavantable[ic].ParameterReportItemtList.dd.timekongjian){
                            searchdata.push(this.cavantable[ic].ParameterReportItemtList.dd.timekongjian)
                        }
                          if(this.cavantable[ic].ParameterReportItemtList.dd.wenbenkongjian){
                            searchdata.push(this.cavantable[ic].ParameterReportItemtList.dd.wenbenkongjian)
                        }
                          if(this.cavantable[ic].ParameterReportItemtList.dd.xialakongjian){
                            searchdata.push(this.cavantable[ic].ParameterReportItemtList.dd.xialakongjian)
                        }
                          if(this.cavantable[ic].ParameterReportItemtList.dd.endkongjian){
                            searchdata.push(this.cavantable[ic].ParameterReportItemtList.dd.endkongjian)
                        }
                        this.cavantable[ic].ParameterReportItemtList.dd.kopngjianarray.forEach((item)=>{
                           if(item.kjnum){
                ...
                if (
                    this.cavantable[ic].ParameterReportItemtList.dd.cfkongjian ==
                    a.class||a=='默认查询'
                ) {
                    //  alert('111')
                    ...
                    wantnum = wantnum.filter(item => {
                      ...
                      this.cavantable[ic].ParameterReportItemtList.dd.kzresourcedataitemarray = dataarry;
                    }
                    end = {};
                    ...
                    if (end.argwaibuparalist.length !== 0) {
                        for (let j = 0; j < end.argwaibuparalist.length; j++) {
                            if (end.argwaibuparalist[j].kjtype == '时间') {
                                  ...
                                  if($($($('.' + end.argwaibuparalist[j].kjtext)[0]).find('input')[0]).attr('cx') == '精确匹配'){
                       
                                 end.argwaibuparalist[j].matchtype = '精确匹配'
                            }else if($($($('.' + end.argwaibuparalist[j].kjtext)[0]).find('input')[0]).attr('cx') == '模糊匹配'){
                                    ...
                                    .find('input')
                                    .val();
                            }else if(end.argwaibuparalist[j].kjtype == '数值'){
                                for(let i1=0;i1<Numbervalue.length;i1++){
                                    if(end.argwaibuparalist[j].kjnum == Numbervalue[i1].name){
                                        end.argwaibuparalist[j].value1 =  Number(Numbervalue[i1].value1)
                                         end.argwaibuparalist[j].value2 =  Number( Numbervalue[i1].value2)
                                         end.argwaibuparalist[j].itemshuzhitype =  Numbervalue[i1].type
                                    }
                                }
                                // end.argwaibuparalist[j].endtime = $(
                                //     $('.' + end.argwaibuparalist[j].kjend)[0]
                         ...
                         if (res.data.data == '无数据'||res.data.data=="[]") {
                            ...
                            for (
                                ...
                                for (let a1 = 0; a1 < a.length; a1++) {
                                    ...
                                    if (one.cellparalist[a2].itemdata == a[a1].name &&one.cellparalist[a2].sumtype == a[a1].sumtype&&one.cellparalist[a2].itemdata
                                    ) {
                    ...
                    if (threenum.length !== 0||end.kzresource=='外部数据源') {
                        let wantarr = [];
                        for (
                            let i3 = 0;
                  ...
                  await this.$axios({
                        ...
                        .then(res => {
                           var a2 = [];
                            ...
                            if (
                                res.data.data == '无数据' ||
                                a2.length <= this.cavantable[ic].nowlength||res.data.data =='[]'
                            ) {
				 ...
				 <div class="end">${this.cavantable[ic].numpage}</div>
                                ...
                                //   console.log("333213")
                                    ...
                                    if (
                                        ...
                                        if (
                                            this.cavantable[ic].page == undefined
                                        ) {
                            ...
                            this.$nextTick(() => {
                                for (
                                    ...
                                    if (
                                        ...
                                        if(this.cavantable[ic].sju[ac].itemformat){
 this.cavantable[ic].sju[ac].itemformat = this.cavantable[ic].sju[ac].itemformat.replace('dd','DD')
                                        this.cavantable[ic].sju[ac].itemformat = this.cavantable[ic].sju[ac].itemformat.replace('yyyy','YYYY')
                                        }
                                       
                                        $('#' + this.cavantable[ic].Name).find(
                                            '#' + this.cavantable[ic].sju[ac].id
                                        )[0].innerHTML = moment().format( this.cavantable[ic].sju[ac].itemformat);
                                        console.log('时间',this.cavantable[ic].sju[ac].itemformat)
                                    }
                                    if (
                                        this.cavantable[ic].sju[ac].itemdata ==
                                        '查询账号'
...
if(!b&&b!==undefined){
                            ...
                            for (let j = 0; j < this.roww; j++) {
                                ...
                                if (
                                    ...
                                    let inp = document.createElement('input');
                                            if($($($('#' +this.cavantable[is].Name).find(`#row-` + this.enum)[0]).find('.dataready')[this.ead]).attr('valign') == 'bottom'){
                                    ...
                                    }else    if($($($('#' +this.cavantable[is].Name).find(`#row-` + this.enum)[0]).find('.dataready')[this.ead]).attr('valign') == 'top'){
                                    ...
                                    for (
                                        ...
                                        if (
                                            ...
                                            itemformat = this.cavantable[is].shi6
                                                .itemformat;
                                            break;
                                        } else {
                                            itemformat = null;
                                ...
                                if(inp.id == 'null'){
                                    ...
                                    if(inp.value){
                                        if(itemformat){
                                           inp.value = this.dateFormat(itemformat,inp.value) 
                                        }
                                    }
                                ...
                                // console.log("ssssssssssssssssssssssssss11111")
                                 ...
                                 if($($($('#' +this.cavantable[is].Name).find(`#row-` + this.enum)[0]).find('.dataready')[this.ead]).attr('valign') == 'bottom'){
                                    ...
                                    let inp = document.createElement('input');
                                       ...
                                       if($($($('#' +this.cavantable[is].Name).find(`#row-` + this.enum)[0]).find('.dataready')[this.ead]).attr('valign') == 'bottom'){
                                                                               if($($($('#' +this.cavantable[is].Name).find(`#row-` + this.enum)[0]).find('.dataready')[this.ead]).attr('valign') == 'bottom'){
                                                  console.log($($($('#' +this.cavantable[is].Name).find(`#row-` + this.enum)[0]).find('.dataready')[this.ead]))
                                    console.log($($($('#' +this.cavantable[is].Name).find(`#row-` + this.enum)[0]).find('.dataready')[this.ead]).attr('valign'))
                                                inp.style.bottom =
                                            -($(
                                                $(
                                                    '#' +
 ...
 if (
           ...
           if((j) !==  0&&parseFloat( this.cavantable[is].startpox)!==parseFloat( this.cavantable[is].endpox)){
    $(
                                            $(
                                                '#' + this.cavantable[is].Name
                                            ).find(
     ...
     if((j) !==  0){
                                                    $(
                                                        ...
                                                        j
															...
															if(parseFloat(this.cavantable[is].startpox)==parseFloat(this.cavantable[is].endpox)){$(
                                                        $(
                                                            '#' +
                                                                this.cavantable[
                                                                    is
...
if(j!==0&&parseFloat( this.cavantable[is].startpox)!==parseFloat( this.cavantable[is].endpox)){
 ...
 $(
                                                        ...
                                                        min[min.length - 1];
                                                                                                        ...
                                                                                                        if(parseFloat(this.cavantable[is].startpox)==parseFloat(this.cavantable[is]).endpoy){
 $(
                                                        $(
                                                            '#' +
                                                                this.cavantable[
                            ...
                            for (let j = 0; j < this.colh; j++) {
                                ...
                                if (
                                    ...
                                    for (
                                     ...
                                     for (
                                        ...
                                        if (
                                            ...
                                            itemformat = this.cavantable[is].shi6[i1].itemformat;
                                            break;
                                        } else {
                                            itemformat = null;
                                        }
                                    ...
                                    if (xsnumber !== '') {
                                        if (
                                            ...
                                            if (de !== '') {
                                                         if($(
                                        $('#' + this.cavantable[is].Name).find(
                                            `#row-` +  parseInt(this.cavantable[is].nowy)
                                        )[0]
                                    )
                                        .find('input')[this.ead].value){
                                                    inp.value = de;
                                                }
                                    ...
                                    if(typeof($($('#'+this.cavantable[is].Name).find('#row-'+this.enum)[0]).find('.dataready').attr('valign'))!=='undefined'){
                                           if($($($('#'+this.cavantable[is].Name).find('#row-'+this.enum)[0]).find('.dataready')[this.ead]).attr('valign')=='bottom'){
                                               inp.style.bottom = -($($('#'+this.cavantable[is].Name).find('#row-'+this.enum)[0]).find('.dataready')[this.ead].clientHeight/2)+'px'
                                           }else  if($($($('#'+this.cavantable[is].Name).find('#row-'+this.enum)[0]).find('.dataready')[this.ead]).attr('valign')=='top'){
                                          inp.style.top =  -($($('#'+this.cavantable[is].Name).find('#row-'+this.enum)[0]).find('.dataready')[this.ead].clientHeight/2)+'px'
                                    }
                                    }
                                    inp.style.width =
                                        $(
                                    ...
                                    for (
                                        ...
                                        for (let vx = 0; vx < this.colw; vx++) {
                                                        ...
                                                        isNaN(
                                                           $(
                                                            $(
                                                                ...
                                                                .value
                                                        )&&this.cavantable[is].shi5[aindex].defauldisplay!== $(
                                                            $(
                                                                '#' +
                                                                    this
                                                                        .cavantable[
                                            ...
                                            console.log(this.$math)
                                                sum = this.$math.add(this.$math.bignumber(sum), this.$math.bignumber(parseFloat(
                                                        $(
                                                            $(
                                                                '#' +
                                                                    this
...
if(vy!==parseFloat(this.cavantable[is].nowy)&&parseFloat( this.cavantable[is].startpoy)!==parseFloat( this.cavantable[is].endpoy)){
  $(
                                                    $(
                                                        '#' +
                                                            this.cavantable[is]
...
if(vy!==parseFloat(this.cavantable[is].nowy)){
 $(
                                                            $(
                                                                '#' +
                                                                    this
...
if(parseFloat(this.cavantable[is].startpoy)==parseFloat(this.cavantable[is].endpoy)){
 $(
                                                            $(
                                                                '#' +
                                                                    this
                ...
                if (
                    ...
                    if (
                        ...
                        for (
                            ...
                            endwidth =
                                endwidth +
                                 $($('#' + this.cavantable[is].Name).find("tr")[this.cavantable[is].ParameterReportItemtList.dd.startpoy]).find('td')[j1]
                                    .clientWidth;
                        }
                        for (
                            let jj = 0;
                        ...
                        $(
                            ...
                            $('#' + this.cavantable[is].Name + 'page')[0]
                                .clientWidth +
                            parseFloat(this.cavantable[is].PropertyList.Left)<=0){
                                 $(
                            '#' + this.cavantable[is].Name + 'page'
                        )[0].style.left = 0 +'px'
                            }else{
...
$(
       ...
       $(
                        ...
                        $(
                            ...
                            'px';
                                      ...
                                      for(let i = 0;i<this.cavantable.length;i++){
                            var z = 0;
                            if(parseInt(this.cavantable[i].ParameterReportItemtList.dd.startpoy)){
                            z = parseInt(this.cavantable[i].ParameterReportItemtList.dd.startpoy)
                            }else{
                            z= 1;
                            }
    let endxlength =   $($('#' + this.cavantable[i].Name).find('tr')[z+1]).find('td').length - 1;
                 let endylength =   $('#' + this.cavantable[i].Name).find('tr').length - 1;
                 var cp = []
                var sc = this.cavantable[i].ParameterReportItemtList.dd.cellparaarray.length
        for(let i1=0;i1<sc;i1++){
        var c = this.cavantable[i].ParameterReportItemtList.dd.cellparaarray[i1].id.split('-');
		if(c[0]<=endxlength&&c[1]<=endylength){
            cp.push(this.cavantable[i].ParameterReportItemtList.dd.cellparaarray[i1])
		
		}
	}
          this.cavantable[i].ParameterReportItemtList.dd.cellparaarray = cp
            }
                ...
                document.onkeydown = function(e,event) {
                    ...
                    if (code == 13) {
                       ...
                       console.log(wantid)
                        for (let i = 0; i < that.cavantable.length; i++) {
                            if ((that.cavantable[i].Name+'page') == wantid) {
                            if (
                                1 <=
                                    parseInt(
                                        $(
                                ...
                                that.cavantable[i].nowdata = f.splice(
                                 ...
                                 console.log("asdasd11",   that.cavantable[i])
                                that.setbodydata(2);
                                break;
                            }
                        }
  ...
  if (this.cavantable[is].numpage <= 1) {
                 ...
                 var that = this
                   $($('#'+this.cavantable[is].Name).find('.datareadyhead')).click(function(){
                        that.$store.state.report = false
                      let a = $('#'+$(this).parent().parent().parent().parent().parent().parent()[0].id).find('.nowinput').length;
                     var tablename1 =$(this).parent().parent().parent().parent().parent().parent()[0].id;
	...
	for(let i=0;i<that.cavantable.length;i++){
		if(that.cavantable[i].Name == tablename1){
			kz = that.cavantable[i].ParameterReportItemtList.dd.kzdirection
    ...
    if(kz == '纵向扩展'){
         ...
         for(let i=0;i<$($(this).parent().parent()[0]).find('.datareadyhead').length;i++){
                 $($($(this).parent().parent()[0]).find('.datareadyhead')[i]).addClass('nowinput')
        }
    }
        ...
        for(let i=0;i<that.cavantable.length;i++){
           if(tablename1 == that.cavantable[i].Name){
               row1 = parseInt(that.cavantable[i].ParameterReportItemtList.dd.startpoy)-1
               col1 = parseInt(that.cavantable[i].ParameterReportItemtList.dd.startpox)-1
               col = parseInt($(this).parent()[0].id.split('-')[0]) - parseInt(that.cavantable[i].ParameterReportItemtList.dd.startpox)+1
               row = parseInt($(this).parent()[0].id.split('-')[1]) - parseInt(that.cavantable[i].ParameterReportItemtList.dd.startpoy)+1
           }
        }
        ...
        var Typearr = []
           ...
           if(tablename1 == EventScriptList[i1].ElementName 
              && EventScriptList[i1].EventType == 'MouseLeftButtonDown'){
        ...
        for(let a2=0;a2<Typearr.length;a2++){
            ...
            for(let a3 =0;a3<T[a2].length;a3++){
                ...
                if(T[a2][a3] == 'etSelectCellReportName('){
                 ...
                 let t2 = parseInt(parseInt(t1[1].replace("\"","").replace("\"","")))+col1;
                 let t3= parseInt(parseInt(t1[2].replace("\"","").replace("\"","")))+row1;
                  o3.Controls = tablename1
                  o3.Property = 'GetCell:'+t1[1].replace("\"","").replace("\"","")+','+t1[2].replace("\"","").replace("\"","")
                  if(t3>=(row1+1)&&t2>=(col1+1)){
                 if($($('#'+tablename1).find("#"+t3+'-'+ t2)[0]).find('input')[0]){
                   o3.Value = $($($('#'+tablename1).find("#"+t3+'-'+ t2)[0]).find('input')[0]).val()
                    }else if($($('#'+tablename1).find("#"+t3+'-'+ t2)[0]).hasClass('datareadyhead')){
                           o3.Value = $($('#'+tablename1).find("#"+t3+'-'+ t2)[0]).text()
                    }
                  }
                  o2.push(o3)
                }
              ...
              if(res.data.code == 0&&res.data.data){
                  for(let i=0;i<res.data.data.length;i++){
                      if(res.data.data[i].Property == "Refresh"){
                       ...
                       for(let j=0;j<that.cavantable.length;j++){
 
                           if(that.cavantable[j].Name == res.data.data[i].Control)
                               var a5 = {
                                   class:that.cavantable[j].ParameterReportItemtList.dd.cfkongjian
                               }
                                let a = $('#'+tablename1).find('.nowinput').length
                           
		for(let i1 = 0;i1<a;i1++){
			$( $('#'+tablename1).find('.nowinput')[0]).removeClass('nowinput')
        }
                           that.search(a5)
         ...
         $($('#'+this.cavantable[is].Name).find('input')).click(function(){
              that.$store.state.report = false
             let a = $('#'+$(this).parent().parent().parent().parent().parent().parent().parent()[0].id).find('.nowinput').length;
             var tablename1 =$(this).parent().parent().parent().parent().parent().parent().parent()[0].id;
		for(let i1 = 0;i1<a;i1++){
			$( $('#'+$(this).parent().parent().parent().parent().parent().parent().parent()[0].id).find('.nowinput')[0]).removeClass('nowinput')
        }
                             var kz
	for(let i=0;i<that.cavantable.length;i++){
		if(that.cavantable[i].Name == tablename1){
    ...
    if(kz == '纵向扩展'){
      ...
      var id = parseInt($($(this).parent()[0]).attr('id').split('-')[0])
			...
			for(let i=0;i<$($("#"+tablename1)[0]).find('.dataready').length;i++){
				if(parseInt($($($("#"+tablename1)[0]).find('.dataready')[i]).attr("id").split("-")[0]) == id){
					$($($($("#"+tablename1)[0]).find('.dataready')[i]).find('input')[0]).addClass('nowinput')
					$($($("#"+tablename1)[0]).find('.dataready')[i]).addClass('nowinput')
				}
        ...
        while((res = reg.exec(str))!=null){
          ...
          if(data.length){
            for(let j=0;j<data.length;j++){
              var reg1 = /GetSelectCellReportName\(/g;var reg2 = /\\/g;var reg3 = /"\)/g  
              var vaee
                        ...
                        this.$nextTick(() => {
                            ...
                            for (
                                ...
                                if (
                                    ...
                                    if(this.cavantable[i].sju[ac].itemformat){
 this.cavantable[i].sju[ac].itemformat = this.cavantable[i].sju[ac].itemformat.replace('dd','DD')
                                      this.cavantable[i].sju[ac].itemformat = this.cavantable[i].sju[ac].itemformat.replace('yyyy','YYYY')
                                    }
                                     
                                    $('#' + this.cavantable[i].Name).find(
                                        '#' + this.cavantable[i].sju[ac].id
                                    )[0].innerHTML = moment().format( this.cavantable[i].sju[ac].itemformat);
                                      console.log('时间',this.cavantable[i].sju[ac].itemformat)
                                } else if (
                                    this.cavantable[i].sju[ac].itemdata ==
                                    '查询账号'
                                ) {
                                        ...
                                        if($('#' + this.cavantable[i].Name).find(
                                            '#' + this.cavantable[i].sju[ac].id
                                        )[0]!==undefined){
                                                          if (
                                        !JSON.parse(

<template>
    <div
        class="MonthlyConsumptionReport-Page"
...
export default {
    ...
    methods: {
        initTable(query) {
            this.$axios({
                method: 'get',
                url: `/api/EnergyConsumptionReport/GetMonthlyConsumptionDataByTime?paramType=${query.paramType}&time=${query.time}&isBSystem=${query.isBSystem}`,
            }).then((res) => {
        ...
        formSave() {
            ...
            this.$axios({
                method: 'post',
                url: `/api/EnergyConsumptionReport/EditMonthlyConsumptionData?type=${this.query.paramType}&time=${this.query.time}`,
                data: queryList,
            }).then((res) => {
                this.tipShow = true;
                this.tipword = '保存成功！';

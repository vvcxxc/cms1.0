<template>
    <div class="oxygenContentReport-Page" :class="{ blackBlueBg: $store.state.color === 'blackBlue' }">
        ...
        <div class="page-center0">
            <div class="select">
                <div class="select-l">
                    ...
                    <el-button class="select-btn" @click="CurrentKilnContainsOxygenQuery">刷新</el-button>
                </div>
                <div class="select-print">
                    <el-button class="select-btn2" @click="htmlToPdf('table-content1')">打印预览</el-button>
                    <el-button class="select-btn2" @click="doPrint('table-content1')">报表打印</el-button>
                    <el-button class="select-btn3" @click="exportTable('table-content1')">导出</el-button>
                </div>
            </div>
            <div class="content">
                <div class="table-content1" id="table-content1">
                    <el-table ref="table1" :data="currentData" :border="true" style="width: 100%" height="100%">
                        <el-table-column prop="RecordDate" label="归档时间" width="160" align="center">
                        </el-table-column>
                        <el-table-column prop="Unit" label="含氧量" width="90" align="center">
                        </el-table-column>
                        <el-table-column prop="KilnOxygen1" label="窑炉1" align="center">
                        </el-table-column>
                        <el-table-column prop="KilnOxygen2" label="窑炉2" align="center">
                        </el-table-column>
                        <el-table-column prop="KilnOxygen3" label="窑炉3" align="center">
                        </el-table-column>
                        <el-table-column prop="KilnOxygen4" label="窑炉4" align="center">
                        </el-table-column>
                        <el-table-column prop="KilnOxygen5" label="窑炉5" align="center">
                        </el-table-column>
                        <el-table-column prop="KilnOxygen6" label="窑炉6" align="center">
                        </el-table-column>
                        <el-table-column prop="KilnOxygen7" label="窑炉7" align="center">
                        </el-table-column>
                        <el-table-column prop="KilnOxygen8" label="窑炉8" align="center">
                        </el-table-column>
                        <el-table-column prop="KilnOxygen9" label="窑炉9" align="center">
                        </el-table-column>
                        <el-table-column prop="KilnOxygen10" label="窑炉10" align="center">
                        </el-table-column>
                        <el-table-column prop="KilnOxygen11" label="窑炉11" align="center">
                        </el-table-column>
                        <el-table-column prop="KilnOxygen12" label="窑炉12" align="center">
                        </el-table-column>
                    </el-table>
                </div>
            </div>
    ...
    $store.state.color === 'blackBlue'
        ? 'blackBlueBg tpc'
        : 'normal tpc'
" type="datetime" v-model="seleTime" :clearable="false" placeholder="开始时间" value-format="yyyy-MM-dd HH:mm:ss"
    ...
    $store.state.color === 'blackBlue'
        ? 'blackBlueBg tpc'
        : 'normal tpc'
" type="datetime" v-model="seleTime2" :clearable="false" placeholder="结束时间" value-format="yyyy-MM-dd HH:mm:ss"
                        :style="{ marginLeft: '10px' }"></el-date-picker>
                    <el-button class="select-btn" @click="GetProcessParamDataByTime(1)">查询</el-button>
                </div>
                <div class="select-print">
                    <el-button class="select-btn2" @click="htmlToPdf('table-content2-area')">打印预览</el-button>
                    <el-button class="select-btn2" @click="doPrint('table-content2-area')">报表打印</el-button>
                    <el-button class="select-btn2" v-if="isBSystem" @click="saveTable">报表保存</el-button>
                    <el-button class="select-btn3" @click="exportTable('table-content2')">导出</el-button>
                </div>
            </div>
            <div class="content">
                <div class="table-content2" id="table-content2">
                    <div class="table-content2-area">
                        <el-table ref="table2" :data="tableData" :border="true" style="width: 100%" height='100%'>
                            <el-table-column prop="RecordDate" label="归档时间" width="160" align="center">
                            </el-table-column>
                            <el-table-column prop="Unit" label="含氧量" width="90" align="center">
                            </el-table-column>
                            <el-table-column prop="KilnOxygen1" label="窑炉1" align="center">
                                <template slot-scope="scope">
                                    <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.KilnOxygen1"
                                        @blur="isNumber" />
                                    <span v-else>{{
                            ...
                            <el-table-column prop="KilnOxygen2" label="窑炉2" align="center">
                                <template slot-scope="scope">
                                    <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.KilnOxygen2"
                                        @blur="isNumber" />
                                    <span v-else>{{
                            ...
                            <el-table-column prop="KilnOxygen3" label="窑炉3" align="center">
                                <template slot-scope="scope">
                                    <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.KilnOxygen3"
                                        @blur="isNumber" />
                                    <span v-else>{{
                            ...
                            <el-table-column prop="KilnOxygen4" label="窑炉4" align="center">
                                <template slot-scope="scope">
                                    <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.KilnOxygen4"
                                        @blur="isNumber" />
                                    <span v-else>{{
                            ...
                            <el-table-column prop="KilnOxygen5" label="窑炉5" align="center">
                                <template slot-scope="scope">
                                    <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.KilnOxygen5"
                                        @blur="isNumber" />
                                    <span v-else>{{
                            ...
                            <el-table-column prop="KilnOxygen6" label="窑炉6" align="center">
                                <template slot-scope="scope">
                                    <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.KilnOxygen6"
                                        @blur="isNumber" />
                                    <span v-else>{{
                            ...
                            <el-table-column prop="KilnOxygen7" label="窑炉7" align="center">
                                <template slot-scope="scope">
                                    <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.KilnOxygen7"
                                        @blur="isNumber" />
                                    <span v-else>{{
                            ...
                            <el-table-column prop="KilnOxygen8" label="窑炉8" align="center">
                                <template slot-scope="scope">
                                    <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.KilnOxygen8"
                                        @blur="isNumber" />
                                    <span v-else>{{
                            ...
                            <el-table-column prop="KilnOxygen9" label="窑炉9" align="center">
                                <template slot-scope="scope">
                                    <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.KilnOxygen9"
                                        @blur="isNumber" />
                                    <span v-else>{{
                            ...
                            <el-table-column prop="KilnOxygen10" label="窑炉10" align="center">
                                <template slot-scope="scope">
                                    <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.KilnOxygen10"
                                        @blur="isNumber" />
                                    <span v-else>{{
                            ...
                            <el-table-column prop="KilnOxygen11" label="窑炉11" align="center">
                                <template slot-scope="scope">
                                    <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.KilnOxygen11"
                                        @blur="isNumber" />
                                    <span v-else>{{
                            ...
                            <el-table-column prop="KilnOxygen12" label="窑炉12" align="center">
                                <template slot-scope="scope">
                                    <input type="text" v-if="isBSystem" class="rowInput" v-model="scope.row.KilnOxygen12"
                                        @blur="isNumber" />
                                    <span v-else>{{
                ...
                <div class="my-page">
                    <my-page :pageData="pageData" @req="GetProcessParamDataByTime"></my-page>
                </div>
            </div>
        </div>
    </div>
            ...
            this.$axios
                ...
                .then((res) => {
                    if (res.data.code == 0) {
                        ...
                        this.$nextTick(() => {
                            this.$refs.table2.doLayout(); //解决表格错位
                        });
                    } else {
                        this.tipword = res.data.msg;
                        this.tipchange = true;
...
.oxygenContentReport-Page .el-table__body-wrapper .el-table--border.is-scrolling-left~.el-table__fixed {
...
.oxygenContentReport-Page .el-table--enable-row-hover .el-table__body tr:hover>td {

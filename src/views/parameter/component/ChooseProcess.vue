        ...
        getData() {
            this.$axios({
                ...
                if (res.data.code == 0) {
                    ...
                    if (this.WID) {
                        this.dataList = res.data.data.filter(_ => _.WID != this.WID).filter(_ => (!this.selectItem.some(_2 => _.WID == _2.WID)) && (!this.filterStr || _.WorkName.indexOf(this.filterStr) >= 0))
                    } else {
                        this.dataList = res.data.data.filter(_ => (!this.selectItem.some(_2 => _.WID == _2.WID)) && (!this.filterStr || _.WorkName.indexOf(this.filterStr) >= 0))
                    }

                        ...
                        <table cellspacing="0" cellpadding="1">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="1" rowspan="1" class="blue-th no3">操作人员</th>
                                    <th colspan="1" rowspan="1" class="blue-th no3">订单号</th>
...
export default {
    ...
    methods: {
        ...
        getdata() {
            this.$axios({
                method: 'post',
                url: `/api/ProcessParameterReport/QueryReportData?DataModification=${true}`,
                data: {

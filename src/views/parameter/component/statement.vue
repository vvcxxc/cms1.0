    ...
    <div class="container">
        ...
        <div class="onework" v-show="onework">
            ...
            <div class="oneworkname">
                <div class="onworkLabel">
                    <span class="require">*</span>工序名称
                </div>
            ...
            <div class="oneworkname2">
                <div class="onworkLabel">
                    <span class="require">*</span>产线段
                </div>
                <el-select
                    type="text"
                    v-model="argProductionLine"
                    style="width:310px"
                >
                    <el-option
            ...
            <div class="oneworkname2">
                <div class="onworkLabel">
                    <span class="require">*</span>设备编号
                </div>
                <el-input type="text" v-model="oneCode" style="width:310px" />
            </div>
            <div class="oneworkname2">
                <div class="onworkLabel">
                    <el-tooltip
                        ...
                        effect="dark"
                        content="对应工位看板展示的IP地址"
                        placement="top"
                    >
                        <img :src="tipsImg" class="tips"
                    /></el-tooltip>
                    IP地址
                </div>
                <el-input type="text" v-model="oneIp" style="width:310px" />
            </div>
            <div class="footer">
        ...
        <div class="changpro" ref="kongtiao6" v-show="projectchange">
            ...
            <div class="changecontent">
                ...
                <!-- <div class="changestion">
                    <span>缩放比</span>
                    <input type="number" v-model="threeObj.Zoom" placeholder="请输入数字" />
                </div> -->
                <div class="changestion">
                    <span> </span>
                    <el-checkbox
                        label="物料参数"
                        v-model="threeObj.IsMaterial"
                    />
                    <el-checkbox
                        label="上下限判断"
                        v-model="threeObj.IsJudgeLimit"
                    />
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <template slot-scope="scope">
                                        <el-checkbox
                                            v-model="scope.row.IsJudgeLimit"
                                        />
                                    </template>
                                </el-table-column>
                            </el-table>
...
export default {
    ...
    data() {
        return {
            ...
            tipsImg: require('../../../assets/images/question.png'),
            tjgxid: '',
            tjgxshow: true,
            xggxid: '',
            xggxshow: true,
    ...
    methods: {
        ...
        getLineList() {
            this.$axios
                .get(`/api/ProcessParameterConfigure/GetLine`)
                .then(res => {
            ...
            if (this.onechange == 2) {
                ...
                this.$axios({
                    ...
                    url: `/api/ProcessParameterConfigure/AddWorkSection?argWId=${''}&argName=${
                        this.oneObj
                    }&argProductionLine=${this.argProductionLine}&argCode=${
                        this.oneCode
                    }&argIp=${this.oneIp}&LoginName=${_name}`
                }).then(res => {
                    this.pdyd5 = true;
                    setTimeout(() => {
                        $('.tip').css({
                ...
                this.$axios({
                    method: 'post',
                    url: `/api/ProcessParameterConfigure/AddWorkSection?argWId=${this.oneworkduan}&argName=${this.oneObj}&argProductionLine=${this.argProductionLine}&argCode=${this.oneCode}&argIp=${this.oneIp}&LoginName=${_name}`
                }).then(res => {
                    this.pdyd5 = true;
                    setTimeout(() => {
                        $('.tip').css({
        ...
        changeone() {
            ...
            if (_obj) {
                ...
                this.argProductionLine = _obj.ProductionLine;
                this.oneIp = _obj.Ip;
                this.oneCode = _obj.Code;
            } else {
                this.WorkCode = '';
                this.argProductionLine = '';
                this.oneIp = '';
                this.oneCode = '';
            }
            // if (this.oneworkname !== '') {

    ...
    <div class="container">
        ...
        <div class="table" :class="{colortip:$store.state.color=='grey'}">
            ...
            <div class="third">
                ...
                <div class="third-btn" :style="{zoom:a11}">
                    <el-upload
                        style="float: right"
                        accept=".xls, .xlsx"
                        action="#"
                    ...
                    >
                        <div class="import-btn" >{{ lang.ProcessParameterConfigure_Excel_WholeImport }}</div>
                    </el-upload>
                    <div class="export-btn" @click="exportExcel">{{ lang.ProcessParameterConfigure_Excel_WholeExport }}</div>
                </div>
                <div class="firsttable">
                    <div class="firstselect" :style="{zoom:a11}">
        ...
        <div class="changpro" ref="kongtiao6" v-show="projectchange" :style="{zoom:a11}">
            ...
            <div class="changecontent">
                ...
                <div class="changestion">
                    <span>{{lang.ProcessParameterConfigure_AddWorkProject1_Format2Number}}</span>
                    <div class="changestion-check">
                        <el-checkbox v-model="threeObj.IsFormat2Number"></el-checkbox>
                    </div>
                </div>
                <div class="cancel" @click="cancel">{{lang.PopupCommon_Cancel}}</div>
                 ...
                 :header-cell-style="{
                    ...
                    padding: '0'
                            ...
                            >
                                ...
                                <el-table-column  prop="IsFormat2Number" :label="lang.ProcessParameterConfigure_AddWorkProject1_Format2Number" :show-overflow-tooltip="true" width="200">
                                    <template slot-scope="scope">
                                        <el-checkbox v-model="scope.row.IsFormat2Number"></el-checkbox>
                                     </template>
                                </el-table-column>
                            </el-table>
                        </div>
    ...
    methods: {
        ...
        if (arrObj.length > 1) {
          ...
          uploadFile(file) {
            ...
            this.$axios({
                method: 'post',
                url: `/api/ProcessParameterConfigure/Import`,
                data: formData
            }).then(res => {
                setTimeout(() => {
                        $('.tip').css({
                ...
                setTimeout(() => {
                    ...
                    this.pdyd5 = true;
                    this.tipword = this.lang.FormulaManage_HT_ImportFailure 
             })
          },
          exportExcel() {
             this.$axios({
                method: 'get',
                url: `/api/ProcessParameterConfigure/Export`,
                responseType: 'blob',
            }).then(res => {
                if (res.status === 200) {
                    this.downloadFile(res.data, this.lang.ProcessConfigure+'.xlsx')
                } else {
                    setTimeout(() => {
                        $('.tip').css({
                            zoom: this.a11,
                    ...
                    this.pdyd5 = true;
                    if (res.data.code != 0) {
                        this.tipword = this.lang.FormulaManage_HT_FormulaManageUserControlViewModel_ExportFailed;
                    }
                }
            })
        },
        ...
        addwantproject() {
            ...
            if (this.adata.length !== 0) {
                ...
                for (let j = 0; j < this.projectlistdata1.length; j++) {
                    console.log('111',this.projectlistdata1[j] )
                    const list=[ '二进制变量','文本变量8位字符集','文本变量16位字符集','字符串','宽字符串','时间','日期','日期时间']
                    if(list.includes(this.projectlistdata1[j].DataType)  ){
                        this.projectlistdata1[j].IsFormat2Number = false;
                    }else{
                        this.projectlistdata1[j].IsFormat2Number = true;
                    }
                 }

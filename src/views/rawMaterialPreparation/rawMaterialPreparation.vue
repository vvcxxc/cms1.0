...
import MaterialPreparation from '../../components/rawMaterialPreparation/MaterialPreparation.vue';
import Record from '../../components/rawMaterialPreparation/record.vue';
export default {
    components: {
        LeftNav,
        MaterialPreparation,
    ...
    data() {
        return {
            componentName: 'MaterialPreparation',
            zoomValue: 0,
            width: 1920,
            zoom: 1,
        };

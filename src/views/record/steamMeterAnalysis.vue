...
<template>
    <!-- <div class="alarm-container">
		<iframe src="http://192.168.1.117:8806" height="100%" width="100%"></iframe>
    </div>-->
    <div class="tapwater">
        <div class="linebox">
...
export default {
    ...
    methods: {
        ...
        exportTable() {
            if (this.headerrows == 1) {
                require.ensure([], () => {
                    ...
                    export_json_to_excel(tHeader, data, '蒸汽计量统计');
                });
            } else {
                console.log('sad');
        ...
        somethingdata1() {
            this.$axios
                .post(
                    `/api/CustomReports/CustomReports_GstData?argReportName=SteamMeasureStatistics&argRange=${this.couponSelected}&argStartTime=${this.starttime}&argEndTime=${this.endtime}&argPageSize=24&argPageIndex=1`
                )
                .then(res => {
                    console.log(res.data.data);
                    // console.log(res.data.headerrows);
                    ...
                    console.log('asd',this.obj.tables);
                    console.log('asd',this.obj.header);
                    let c = 0;
    ...
    mounted() {
        this.changetime();
        console.log(document.getElementById('orderFullScreen'));
    }
};
</script>

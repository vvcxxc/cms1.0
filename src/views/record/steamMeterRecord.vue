...
export default {
    ...
    methods: {
        ...
        exportTable() {
            if (this.headerrows == 1) {
                require.ensure([], () => {
                    ...
                    export_json_to_excel(tHeader, data, '蒸汽表报表记录');
                });
            } else {
                console.log('sad');
                ...
                // );
                //  console.log(wb);
                // //    var wb = XLSX.utils.table_to_book(document.querySelector('#orderFullScreen'));
                ...
                // }
                // return wbout;
                // this.$router.push({path:'`/api/CustomReports/CustomReports_Export?argReportName=SteamReportRecord&argRange=${this.couponSelected}&argStartTime=${this.starttime}&argEndTime=${this.endtime}&argPageSize=24&argPageIndex=1&argFileName=蒸汽表报表记录&argFileType=xls`')};
                // //   this.$axios.get(`/api/CustomReports/CustomReports_Export?argReportName=SteamReportRecord&argRange=${this.couponSelected}&argStartTime=${this.starttime}&argEndTime=${this.endtime}&argPageSize=24&argPageIndex=1&argFileName=蒸汽表报表记录&argFileType=xls`
                // )
                // .then(res => {
                //     console.log(res);
                // })
                ...
                // });
                window.open(
                    `http://192.168.35.171:8802/api/CustomReports/CustomReports_Export?argReportName=SteamReportRecord&argRange=${this.couponSelected}&argStartTime=${this.starttime}&argEndTime=${this.endtime}&argPageSize=24&argPageIndex=1&argFileName=蒸汽表报表记录&argFileType=xls`,
                    '_self'
                );
            }
        },
        ...
        somethingdata1() {
            this.$axios
                .post(
                    `/api/CustomReports/CustomReports_GstData?argReportName=SteamReportRecord&argRange=${this.couponSelected}&argStartTime=${this.starttime}&argEndTime=${this.endtime}&argPageSize=24&argPageIndex=1`
                )
                .then(res => {
                    console.log(res);
    ...
    mounted() {
        this.changetime();
        document
            .getElementById('orderFullScreen')

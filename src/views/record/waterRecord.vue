...
<template>
	...
	<iframe src="http://10.51.1.4:8812" height="100%" width="100%"></iframe>
    </div>-->
    <div class="tapwater">
        <div class="linebox">
            ...
            <div class="tabledata" :style="{width: '100%', height: 'calc(100% - 123px)'}">
                <div class="sad1" id="outTable">
                    ...
                    <div class="asd" id="orderFullScreen" v-if="headerrows == 2" @scroll="handleScroll" >
                    ...
                    <div class="asd1" id="orderFullScreen" v-if="headerrows == 1" @scroll="handleScroll">
                        <div class="tr" v-for="(item,index) in totalData" :key="index">
                            <div
                                class="td"
                                v-for="(value,key,index) in item"
...
export default {
    ...
    methods: {
            ...
            if (this.headerrows == 1) {
                require.ensure([], () => {
                  ...
                  if(this.www == 1){
                    ...
                    export_json_to_excel(tHeader, data, '自来水报表记录');
                });
            } else {
                console.log('sad');
        ...
        somethingdata1() {
            this.$axios
                .post(
                    `/api/CustomReports/CustomReports_GstData?argReportName=TapWaterReportRecord&argRange=${this.couponSelected}&argStartTime=${this.starttime}&argEndTime=${this.endtime}&argPageSize=24&argPageIndex=1`
                )
                .then(res => {
                    console.log(res);

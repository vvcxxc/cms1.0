...
import EquipmentLedger from '../../components/sparepart/EquipmentLedger.vue';
import BaseSetting from '../../components/sparepart/BaseSetting.vue';
import Record from '../../components/sparepart/Record.vue';
export default {
    components: {
        LeftNav,
        EquipmentLedger,

        ...
        <div class="linebox">
            ...
            <div class="tabledata" :style="{width: '100%', height: 'calc(100% - 36% - 82px)'}">
                ...
                >
                    ...
                    <el-table-column prop="DeviceName" label="仪表名称" width="280"></el-table-column>
                    <el-table-column prop="Temperature" label="温度" width="280"></el-table-column>
                    <el-table-column prop="Pressure" label="压力"></el-table-column>
                    <el-table-column prop="InstantFlow" label="瞬时流量" width="280"></el-table-column>
                    <el-table-column prop="CumulationFlow" label="累积流量" width="280"></el-table-column>
                </el-table>
                <table class="bottomtable" cellspacing="0" celloadding="0">
                    <tr>
                        <td class="center" width="740">合计</td>
                        <td class="middle" width="280"></td>
                        <td class="middle" width="260"></td>
                        <td class="middle" width="280"></td>
                        <td class="middle">
                    ...
                    <tr class="topline">
                        <td class="center">最大</td>
                        <td class="middle" width="280">
                            <span v-show="!chardata">0</span>
                            {{chardata.instantMax}}
                        </td>
                        <td class="middle" width="260">
                            <span v-show="!chardata">0</span>
                            {{chardata.cumulationMax}}
                        </td>
                        <td class="middle" width="280">
                            <span v-show="!chardata">0</span>
                            {{chardata.temperatureMax}}
                        </td>
                        <td class="middle">
                            <span v-show="!chardata">0</span>
                            {{chardata.pressureMax}}
                        </td>
                    </tr>
                    <tr>
                        <td class="center">最小</td>
                        <td class="middle" width="280">
                            <span v-show="!chardata">0</span>
                            {{chardata.instantMin}}
                        </td>
                        ...
                        <td class="middle" width="280">
                            <span v-show="!chardata">0</span>
                            {{chardata.temperatureMin}}
                        </td>
                        <td class="middle">
                            <span v-show="!chardata">0</span>
                            {{chardata.pressureMin}}
                        </td>
                    </tr>
                </table>
...
export default {
    ...
    methods: {
            ...
            require.ensure([], () => {
                ...
                let pushdata = [
                    ...
                    },
                    {
                        ...
                        Temperature: this.chardata.temperatureMax,
                        Pressure: this.chardata.pressureMax
                    },
                    {
                        Number: '',
                        Time: '最小',
                        ...
                        Temperature: this.chardata.temperatureMin,
                        Pressure: this.chardata.pressureMin
                    }
                ];
                var trydata = [];
                ...
                export_json_to_excel(tHeader, data, '蒸汽表');
            });
        },
        ...
        somethingdata() {
            this.$axios({
                method: 'post',
                url: `/api/SteamTrendCurve/SteamTrendCurve_GstData?argDevice=${this.Meter.replace(
                    '#',
                    '%23'
                ...
                .then(res => {
                    ...
                    this.option.series[2].data = res.data.data.temperatureData;
                    this.option.series[3].data = res.data.data.pressureData;
        ...
        tablename() {
            ...
            this.$axios({
                method: 'post',
                url: '/api/SteamTrendCurve/SteamTrendCurve_GstDevices'
            })
                .then(res => {
                    console.log('sadasd');

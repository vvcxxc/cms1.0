            ...
            <div class="popContent">
                ...
                <div class="content1">
                    ...
                    <div class="content1-line">
                        ...
                        <div class="content">
                            <div class="contentLable ">更新时间</div>
                    ...
                    <div class="content1-line">
                        <div class="content">
                            <div class="contentLable ">任务类型</div>
                            <el-input type="text" disabled v-model="formData.TypeDisplayName" style="width: 210px" />
                        </div>
                        <div class="content">
                    ...
                    <div class="contentTable">
                        <div class="contentTable-table">
                            <el-table :data="tablelist" border highlight-current-row header-row-class-name="light-blue"
                                ...
                                <el-table-column label="序列号" prop="SEQ"
                                    :show-overflow-tooltip="true"></el-table-column>

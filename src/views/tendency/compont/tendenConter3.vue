  ...
  <div class="conter_head" :class="{colortip:$store.state.color=='grey'}" :style="{
    zoom:zoom1
		...
		<div class="xl" :style="{width: 20*zoom+'%!important'}">
			<el-dropdown class="dro" trigger="click" :style="{height: 40*zoom+'px',lineHeight:40*zoom+'px'}">
    ...
    <div :style="{height:'100%',position:'relative'}">
     <div class="echarts" :style="{width: 100/zoom1+'%','background':color2,height:100/zoom1+'%',zoom:1/zoom1,transform:'scale('+zoom1+')'}" ref="tendency" :id='id'></div>
    </div>

...
<template>
<div class="conterBox1" :class="{blackBlueBg: $store.state.color === 'blackBlue'}" :style="{paddingTop:100*zoom1+'px',height:calcheight}" >
    <div class="head" :class="{colortip:$store.state.color=='grey'}" :style="{zoom:zoom1}">
         <!-- 头部内容 -->
        <div :style="{
            width:'100%',height:70*zoom+'px',
            background:$store.state.color === 'blackBlue'? '#0B1530' :'#DDDDDD',
            border:$store.state.color === 'blackBlue'? '1px solid #38415A' :'0'
        }">
            <div class="head_left" :style="{width: 17*zoom+'%', marginTop:17*zoom+'px'}">
                <span class="head_block" :style="{backgroundColor: this.color1,marginLeft: 2*zoom+'%' }"></span>
                <div class="head_text" ref="timeText1" :style="'color:' + this.color1 + '; fontSize:' +this.value4 * zoom+'px;'">
                    {{titleText}}</div>
            </div>
            <div class="head_right" :style="{width: 100 - (17*zoom)+'%',fontSize:16*zoom+'px'}">
                <div class="timeStar">
                    <div v-if="oneWindow" >
                        <span class="demonstration">{{lang.NewTrendChart_NewTrendChartUserControl_StartTime}}</span>
                        <el-date-picker
                ...
                <div class="timeEnd">
                    <div v-if="oneWindow" >
                        <span class="demonstration">{{lang.NewTrendChart_NewTrendChartUserControl_EndTime}}</span>
                        <el-date-picker
                        :key="$store.state.color === 'blackBlue' ? 'blackBlueBg' : 'normal'"
                        :popper-class="$store.state.color === 'blackBlue' ? 'blackBlueBg' : 'normal'"
                        :disabled="showTime"
                ...
                <div class="buttomQuery" :style="{marginRight: 1*zoom+'%'}"> 
                    <el-button v-if="oneWindow" @click="queryFun()" :disabled="showTime" class="query" type="primary"
                    
                    >{{lang.NewTrendChart_NewTrendChartUserControl_Query}}</el-button>
                </div>
                <div class="show" :style="{height: 40*zoom+'px',fontSize:16*zoom+'px'}">
                    <div @click="show(0)" class="normal" :class="{activeShow: activeShow===0}" :style="{height: 36*zoom+'px',fontSize:16*zoom+'px',lineHeight: 38*zoom+'px'}">{{lang.NewTrendChart_NewTrendChartUserControl_Normal}}</div>
                    <div @click="show(1)" ref="show" class="proport" :class="{activeShow: activeShow===1}" :style="{height: 36*zoom+'px',fontSize:16*zoom+'px',lineHeight: 38*zoom+'px'}">{{lang.NewTrendChart_NewTrendChartUserControl_Proportion}}</div>
                </div>
                <div class="window" :style="{height: 40*zoom+'px',fontSize:16*zoom+'px'}">
                    <div @click="windowClick(lang.NewTrendChart_NewTrendChartUserControl_Single)" class="window_one" 
                        :class="{activeWindow: activeWindow===lang.NewTrendChart_NewTrendChartUserControl_Single}" 
                        :style="{height: 36*zoom+'px',fontSize:16*zoom+'px',lineHeight: 38*zoom+'px'}">{{lang.NewTrendChart_NewTrendChartUserControl_Single}}</div>
                    <div @click="windowClick(lang.NewTrendChart_NewTrendChartUserControl_Double)" class="window_two" 
                        :class="{activeWindow: activeWindow===lang.NewTrendChart_NewTrendChartUserControl_Double}" 
                        :style="{height: 36*zoom+'px',fontSize:16*zoom+'px',lineHeight: 38*zoom+'px'}">{{lang.NewTrendChart_NewTrendChartUserControl_Double}}</div>
                    <div @click="windowClick(lang.NewTrendChart_NewTrendChartUserControl_Several)" class="window_more" 
                        :class="{activeWindow: activeWindow===lang.NewTrendChart_NewTrendChartUserControl_Several}" 
                        :style="{height: 36*zoom+'px',fontSize:16*zoom+'px',lineHeight: 38*zoom+'px'}">{{lang.NewTrendChart_NewTrendChartUserControl_Several}}</div>
                </div>
                <div class="switch" :style="{height: 40*zoom+'px',fontSize:16*zoom+'px'}" >
                ...
                <div @click="open()"  class="set" :style="{height: 36*zoom+'px',fontSize:16*zoom+'px',lineHeight: 34*zoom+'px'}">
                    <span>{{lang.NewTrendChart_NewTrendChartUserControl_Settings}}</span>
                </div>
        </div>
            <!-- 图表设置弹窗 -->
            <div  class="Popshow" :style="{width: 800*zoom+'px', height: 700*zoom+'px'}">
                <div v-drag class="head" :class="{colortip2:$store.state.color=='grey'}" :style="{marginTop: 'unset',height: 60*zoom+'px',lineHeight:60*zoom+'px'}">
                    <span class="text" :style="{fontSize: 24*zoom+'px'}">{{lang.NewTrendChart_ChartSetting_ChartSetting}}</span>
                    <span @click="cancel" class="i-c el-icon-close" :style="{fontSize: 30*zoom+'px'}"></span>
                </div>
                <div class="conter" :style="{height: 605*zoom+'px',marginTop: 20*zoom+'px',marginBottom: 20*zoom+'px',}">
                    <div class="conter_head">
                       <div class="blo"></div>
                       <div class="text" :style="{fontSize: 20*zoom+'px',lineHeight: 24*zoom+'px'}">{{lang.NewTrendChart_ChartSetting_TitleSetting}}</div>
                       <div class="line"></div>
                    </div>
                    <div class="conter_conter" :style="{height: 40*zoom+'px', marginTop: 20*zoom+'px'}">
                        <div class="text" :style="{width: 147*zoom+'px',marginLeft: 20*zoom+'px',lineHeight: 40*zoom+'px'}">{{lang.NewTrendChart_ChartSetting_TitleContent}}</div>
                        <input ref="timeText" :style="{
                            fontSize:this.value4*zoom+'px', 
                            color:this.color1,
                            height: 40*zoom+'px',
                        }" class="time" v-model="titleText">
                    </div>
                    <div class="conter_xiala" :style="{height: 40*zoom+'px',marginTop: 15*zoom+'px'}">
                        <div class="empty-title" :style="{width: 110*zoom+'px',minWidth: 110*zoom+'px',marginLeft: 20*zoom+'px',marginRight: 36*zoom+'px'}"></div>
                        <el-select @focus='sx' :popper-append-to-body="false" @change="textFontSelect" class="text" v-model="value1" :placeholder="lang.SCMSConsoleWebApiMySql_PleChoose">
                            <el-option
                            ...
                            <div class="blo" :style="{marginLeft:15*zoom+'px',marginRight:15*zoom+'px',width: 40*zoom+'px',height: 40*zoom+'px', }">
                                <el-color-picker
                                    @change="colorSelect"
                                    v-model="color1"
                            ...
                            <el-select @focus='sx' :popper-append-to-body="false" class="num" @change="SizeNum" v-model="value4" :placeholder="lang.SCMSConsoleWebApiMySql_PleChoose">
                                <el-option
                            ...
                            <div ref="B" @click="textWeight" class="B" :style="{width: 70*zoom+'px',height: 40*zoom+'px',lineHeight: 40*zoom+'px'}">B</div>
                            <div ref="I" @click="textIta" class="I" :style="{width: 70*zoom+'px',height: 40*zoom+'px',lineHeight: 40*zoom+'px'}">I</div>
                    </div>
                     <div class="conter_show" :style="{height: 40*zoom+'px', marginTop: 20*zoom+'px'}">
                       <div class="blo"></div>
                       <div class="text" :style="{fontSize: 20*zoom+'px',lineHeight: 24*zoom+'px'}">{{lang.NewTrendChart_ChartSetting_DisplaySettings}}</div>
                       <div class="line">
                       </div>
                    </div>
                    <div class="showSetting">
                        <div class="conter_back" :style="{height: 40*zoom+'px', marginTop: 15*zoom+'px'}">
                            <div class="text" :style="{fontSize: 16*zoom+'px'}">{{lang.NewTrendChart_ChartSetting_ChartAreaBackground}}</div>
                            <div class="back" :style="{marginRight:15*zoom+'px',width: 40*zoom+'px',height: 40*zoom+'px', }">
                                <el-color-picker
                        ...
                        <div class="conter_ray" :style="{height: 40*zoom+'px',lineHeight: 40*zoom+'px', marginTop: 15*zoom+'px'}">
                            <div class="text" :style="{fontSize: 16*zoom+'px'}">{{lang.NewTrendChart_ChartSetting_Cursor}}</div>
                            <div class="ray" :style="{marginRight:15*zoom+'px',width: 40*zoom+'px',height: 40*zoom+'px', }">
                                <el-color-picker
                        ...
                        <div class="conter_line" :style="{height: 40*zoom+'px',lineHeight: 40*zoom+'px', marginTop: 15*zoom+'px'}">
                            <div class="text" :style="{fontSize: 16*zoom+'px'}">{{lang.NewTrendChart_ChartSetting_AuxiliaryGridLine}}</div>
                            <div class="line" :style="{marginRight:15*zoom+'px',width: 40*zoom+'px',height: 40*zoom+'px', }">
                                <el-color-picker
                        ...
                        <div class="x_coordinate" :style="{height: 40*zoom+'px', marginTop: 15*zoom+'px'}">
                            <div class="x_text" :style="{fontSize: 16*zoom+'px'}">{{lang.NewTrendChart_ChartSetting_AbscissaText}}</div>
                            <el-select @focus='sx' :popper-append-to-body="false" @change="textFontSelect1('2')" class="text" v-model="value2" :placeholder="lang.SCMSConsoleWebApiMySql_PleChoose">
                                    <el-option
                                    v-for="item in options"
                                    :key="item.value"
                                    :label="item.label"
                                ...
                                <el-select @focus='sx' :popper-append-to-body="false" @change="SizeNum1('5')" class="num" v-model="value5" :placeholder="lang.SCMSConsoleWebApiMySql_PleChoose">
                                    <el-option
                                    v-for="item in optionsNum"
                                    :key="item.value"
                                    :label="item.label"
                            ...
                            <div @click="textWeight1('x')" ref="Xb" class="b" :style="{height: 40*zoom+'px',lineHeight: 40*zoom+'px'}">B</div>     
                        </div>
                        <div class="x_coordinate" :style="{height: 40*zoom+'px', marginTop: 15*zoom+'px'}">
                            <div class="x_text" :style="{fontSize: 16*zoom+'px'}">{{lang.NewTrendChart_ChartSetting_OrdinateText}}</div>
                            <el-select @focus='sx' :popper-append-to-body="false" @change="textFontSelect1('3')" class="text" v-model="value3" :placeholder="lang.SCMSConsoleWebApiMySql_PleChoose">
                                    <el-option
                                    v-for="item in options"
                                    :key="item.value"
                                    :label="item.label"
                            ...
                            <el-select @focus='sx' :popper-append-to-body="false" @change="SizeNum1('6')" class="num" v-model="value6" :placeholder="lang.SCMSConsoleWebApiMySql_PleChoose">
                                    <el-option
                                    v-for="item in optionsNum"
                                    :key="item.value"
                                    :label="item.label"
                                ...
                                <div @click="textWeight1('y')" ref="Yb" class="b" :style="{height: 40*zoom+'px',lineHeight: 40*zoom+'px'}">B</div>   
                        </div>
                    ...
                    <div v-if="confirShow"  class="deletePop" >
                        ...
                        <div class="delete_text delete_text11">
                            {{lang.QualityManage_HT_SampleChoseUserControlViewModel_SuccessfullySaved}}
                        </div>
...
export default {
    ...
    created(){
        ...
        this.axiosSet()
        this.powerBtn()
        this.activeWindow = this.lang.NewTrendChart_NewTrendChartUserControl_Single
    },
       ...
       powerBtn(){
        //    debugger
                  ...
                  for(let i=0;i<powerData.length;i++){
                    ...
                    var btnTextArr = ['单窗口-查询按钮','单窗口','双窗口','多窗口','实时历史切换按钮',
                        '设置按钮','单窗口-编辑按钮','单窗口-删除按钮','单窗口-导出按钮','双窗口-查询按钮',
                        '多窗口-查询按钮','单窗口-选择曲线','单窗口-正常显示/按比例']
                    var btnIdArr = []
                  for(let j1=0;j1<btnTextArr.length;j1++){
                      for(let i1=0;i1<btnData.length;i1++){
                          if(btnTextArr[j1] == btnData[i1].RightName){
                              btnIdArr.push(btnData[i1].RightID)
                          }
                      }
                  }
                //   单窗口-选择曲线
                // 单窗口-正常显示/按比例
                    this.queryId = btnIdArr[0]
                    this.oneWindowId = btnIdArr[1]
                    this.twoWindowId = btnIdArr[2]
                    this.moreWindowId = btnIdArr[3]
                    this.changeTypeId = btnIdArr[4]
                    this.setId = btnIdArr[5]
                    this.editId = btnIdArr[6]
                    this.deleteId = btnIdArr[7]
                    this.exportId=btnIdArr[8]
                    this.queryId2 = btnIdArr[9]
                    this.queryId3 = btnIdArr[10]
                    this.selectId = btnIdArr[11]
                    this.showTypeId = btnIdArr[12]
                    //历史实时开发是否有权限
        ...
        isPower(id,num){
          return new Promise((resolve, reject) => {
                ...
                if(num == '编辑'){
                    ...
                    argRightID = this.deleteId
                }else if(num == '导出'){
                    argRightID = this.exportId
                }else if(num == '双窗口查询'){
                    argRightID = this.queryId2
                }else if(num == '多窗口查询'){
                    argRightID = this.queryId3
                }else if(num == '选择曲线'){
                    argRightID = this.selectId
                }
                this.$axios({                      //权限配置请求接口
                    method: 'post',
       ...
       textWeight1(text){
        ...
        axiosSet(){
          ...
          url:"/api/NewTrendChart/QueryChartSetting",
              ...
              this.$nextTick(()=>{
                  if(this.$refs.timeText){
                      this.$refs.timeText.style.color= this.getColor(res.data.data.ChartForeground)
                  }
                  if( res.data.data){
                      console.log(res.data.data, res.data.data.ChartTitle)
                      ...
                      this.color1 = this.getColor(res.data.data.ChartForeground)
    ...
    &.blackBlueBg{
        ...
        .Popshow{
            ...
            .conter{
                ...
                .show_value input[type=checkbox]{
                    &:after{
                        border: unset;
                        content: "";
                        left: 0;

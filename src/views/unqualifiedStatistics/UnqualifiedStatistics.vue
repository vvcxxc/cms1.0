...
<template>
    <div
        class="tapwater unqualifiedStatistics"
        ...
        >
            <div class="table clearfix">
                ...
                <div
                    ...
                    :id="cxid"
                    :style="[
                        { lineHeight: 36 * 1 < 36 ? 36 + 'px' : 36 * 1 + 'px' },
                        { height: 40 * 1 < 40 ? 40 : 40 * 1 + 'px' },
                        { fontSize: 16 * 1 + 'px' },
                        { width: 120 * 1 + 'px' }
                    ]"
                >
...
export default {
    ...
    data() {
        return {
            ...
            ZHObj: {
                chartitle: '不合格品统计',
                templechartitle: '不合格原因统计模板',
                subcharttitle: '不合格原因统计',
                tablecell0: '设备',
                tablecell1: '数量',
                tablecell2: '百分比',
                tablecell3: '累计百分比',
    ...
    created() {
        ...
        console.log('btnn', this.buttonarr);
    ...
    methods: {
        ...
        tablename() {
            ...
            this.$axios({
                method: 'get',
                url: `/api/UnqualifiedStatistics/GetDatasResult?productTypeCode=&start=${this.value1}&end=${this.value2}`
            }).then(res => {
                console.log('res', res);
                this.try = 2;
                if (res.data.code == 0) {
